...
const resourcesContractEvidence = {
  ...
  workspaceLifecycleViewModel: manifest.resourceBoundary?.providerLifecycleViewModel,
  ...
  homeWorkbenchLoadResult: manifest.resourceBoundary?.homeWorkbenchLoadResult,
  resourceLoadResult: manifest.resourceBoundary?.resourceLoadResult,
  ...
  comparedSources: [
    ...
    manifest.resourceBoundary?.providerLifecycleViewModel,
    ...
    manifest.resourceBoundary?.homeWorkbenchLoadResult,
    manifest.resourceBoundary?.resourceLoadResult,
