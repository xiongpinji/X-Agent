          ...
          >
            ...
            <div className="space-y-3">
              ...
              {form.transport === 'http' ? (
                <>
                  <div>
                    <label htmlFor="mcp-form-url" className={labelCls}>URL</label>
                    <input id="mcp-form-url" className={input} value={form.url} onChange={(e) => setForm({ ...form, url: e.target.value })} placeholder="http://localhost:8001" />
                  </div>
                  <div>
