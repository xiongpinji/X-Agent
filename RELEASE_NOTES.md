...
- Only after owner-controlled provider, Feishu, GitHub test-resource, and hosted GitHub Actions gates are verified for the current commit SHA does the final RC gate report `ready_for_rc_tag`.
