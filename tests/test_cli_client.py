...
class TestHTTPClient:
    ...
    @pytest.mark.asyncio
    async def test_http_client_record_sdk_runtime_flag_application_adapter_design_review_calls_owner_gated_stub(self):
        """Test SDK runtime flag adapter design review uses the backend evidence stub."""
        config = CLIConfig(api_base_url="http://localhost:8000")
        client = HTTPClient(config)
        payload = {
        ...
        with patch.object(
            ...
            result = await client.record_sdk_runtime_flag_application_adapter_design_review(payload)
            ...
            assert call_args[1]["json"] == payload
            assert result["status"] == "sdk_live_runtime_flag_application_adapter_design_review_workflow_ready"
            assert result["adapter_design_review"]["runtime_flag_enabled"] is False
            assert result["adapter_design_review"]["flag_application_performed"] is False
            assert result["adapter_design_review"]["implementation_enabled"] is False
            assert result["adapter_design_review"]["execute_enabled"] is False
            assert result["adapter_design_review"]["write_runner_enabled"] is False
            assert result["adapter_design_review"]["adapter_execution_enabled"] is False
            assert result["adapter_design_review"]["runner_invoked"] is False
            assert result["adapter_design_review"]["mutation_performed"] is False
            assert result["adapter_design_review"]["adapter_import_allowed"] is False
            assert result["adapter_design_review"]["adapter_execution_allowed"] is False

    @pytest.mark.asyncio
    async def test_http_client_record_sdk_runtime_flag_application_adapter_implementation_preflight_calls_owner_gated_stub(self):
        """Test SDK runtime flag adapter implementation preflight uses the backend evidence stub."""
        config = CLIConfig(api_base_url="http://localhost:8000")
        client = HTTPClient(config)
        payload = {
        ...
        with patch.object(
            ...
            result = await client.record_sdk_runtime_flag_application_adapter_implementation_preflight(payload)
            ...
            assert call_args[1]["json"] == payload
            assert result["status"] == "sdk_live_runtime_flag_application_adapter_implementation_preflight_workflow_ready"
            assert result["adapter_implementation_preflight"]["runtime_flag_enabled"] is False
            assert result["adapter_implementation_preflight"]["flag_application_performed"] is False
            assert result["adapter_implementation_preflight"]["implementation_enabled"] is False
            assert result["adapter_implementation_preflight"]["execute_enabled"] is False
            assert result["adapter_implementation_preflight"]["write_runner_enabled"] is False
            assert result["adapter_implementation_preflight"]["adapter_execution_enabled"] is False
            assert result["adapter_implementation_preflight"]["runner_invoked"] is False
            assert result["adapter_implementation_preflight"]["mutation_performed"] is False
            assert result["adapter_implementation_preflight"]["adapter_import_allowed"] is False
    ...
    @pytest.mark.asyncio
    async def test_http_client_record_sdk_runtime_flag_application_adapter_wiring_calls_owner_gated_stub(self):
        """Test SDK runtime flag adapter wiring gate uses the backend evidence stub."""
        config = CLIConfig(api_base_url="http://localhost:8000")
        client = HTTPClient(config)
        payload = {
        ...
        with patch.object(
            ...
            result = await client.record_sdk_runtime_flag_application_adapter_wiring(payload)
            ...
            assert call_args[1]["json"] == payload
            assert result["status"] == "sdk_live_runtime_flag_application_adapter_wiring_workflow_ready"
            assert result["adapter_wiring"]["runtime_flag_enabled"] is False
            assert result["adapter_wiring"]["flag_application_performed"] is False
            assert result["adapter_wiring"]["implementation_enabled"] is False
            assert result["adapter_wiring"]["execute_enabled"] is False
            assert result["adapter_wiring"]["write_runner_enabled"] is False
            assert result["adapter_wiring"]["adapter_execution_enabled"] is False
            assert result["adapter_wiring"]["runner_invoked"] is False
            assert result["adapter_wiring"]["mutation_performed"] is False
            assert result["adapter_wiring"]["adapter_import_allowed"] is False
            assert result["adapter_wiring"]["adapter_execution_allowed"] is False
            assert result["adapter_wiring"]["wired_into_sdk_invoke"] is False
            assert result["adapter_wiring"]["adapter_runtime_wired"] is False

    @pytest.mark.asyncio
    async def test_http_client_record_sdk_runtime_flag_application_adapter_runtime_preflight_calls_owner_gated_stub(self):
        """Test SDK runtime flag adapter runtime preflight uses the backend evidence stub."""
        config = CLIConfig(api_base_url="http://localhost:8000")
        client = HTTPClient(config)
        payload = {
        ...
        with patch.object(
            ...
            result = await client.record_sdk_runtime_flag_application_adapter_runtime_preflight(payload)
            ...
            assert call_args[1]["json"] == payload
            assert result["status"] == "sdk_live_runtime_flag_application_adapter_runtime_preflight_workflow_ready"
            assert result["adapter_runtime_preflight"]["runtime_flag_enabled"] is False
            assert result["adapter_runtime_preflight"]["flag_application_performed"] is False
            assert result["adapter_runtime_preflight"]["implementation_enabled"] is False
            assert result["adapter_runtime_preflight"]["execute_enabled"] is False
            assert result["adapter_runtime_preflight"]["write_runner_enabled"] is False
            assert result["adapter_runtime_preflight"]["adapter_execution_enabled"] is False
            assert result["adapter_runtime_preflight"]["runner_invoked"] is False
            assert result["adapter_runtime_preflight"]["mutation_performed"] is False
            assert result["adapter_runtime_preflight"]["adapter_import_allowed"] is False
            assert result["adapter_runtime_preflight"]["adapter_execution_allowed"] is False
            assert result["adapter_runtime_preflight"]["wired_into_sdk_invoke"] is False
            assert result["adapter_runtime_preflight"]["adapter_runtime_wired"] is False

    @pytest.mark.asyncio
    async def test_http_client_record_sdk_runtime_flag_application_adapter_execution_dry_run_calls_owner_gated_stub(self):
        """Test SDK runtime flag adapter execution dry-run uses the backend evidence stub."""
        config = CLIConfig(api_base_url="http://localhost:8000")
        client = HTTPClient(config)
        payload = {
        ...
        with patch.object(
            ...
            result = await client.record_sdk_runtime_flag_application_adapter_execution_dry_run(payload)
            ...
            assert call_args[1]["json"] == payload
            assert result["status"] == "sdk_live_runtime_flag_application_adapter_execution_dry_run_workflow_ready"
            assert result["adapter_execution_dry_run"]["runtime_flag_enabled"] is False
            assert result["adapter_execution_dry_run"]["flag_application_performed"] is False
            assert result["adapter_execution_dry_run"]["implementation_enabled"] is False
            assert result["adapter_execution_dry_run"]["execute_enabled"] is False
            assert result["adapter_execution_dry_run"]["write_runner_enabled"] is False
            assert result["adapter_execution_dry_run"]["adapter_execution_enabled"] is False
            assert result["adapter_execution_dry_run"]["runner_invoked"] is False
            assert result["adapter_execution_dry_run"]["mutation_performed"] is False
            assert result["adapter_execution_dry_run"]["adapter_import_allowed"] is False
            assert result["adapter_execution_dry_run"]["adapter_execution_allowed"] is False
            assert result["adapter_execution_dry_run"]["wired_into_sdk_invoke"] is False
            assert result["adapter_execution_dry_run"]["adapter_runtime_wired"] is False
            assert result["adapter_execution_dry_run"]["execution_dry_run_invoked"] is False

    @pytest.mark.asyncio
    async def test_http_client_record_sdk_runtime_flag_application_adapter_execution_gate_calls_owner_gated_stub(self):
        """Test SDK runtime flag adapter execution gate uses the backend evidence stub."""
        config = CLIConfig(api_base_url="http://localhost:8000")
        client = HTTPClient(config)
        payload = {
        ...
        with patch.object(
            ...
            result = await client.record_sdk_runtime_flag_application_adapter_execution_gate(payload)
            ...
            assert call_args[1]["json"] == payload
            assert result["status"] == "sdk_live_runtime_flag_application_adapter_execution_gate_workflow_ready"
            assert result["adapter_execution_gate"]["runtime_flag_enabled"] is False
            assert result["adapter_execution_gate"]["flag_application_performed"] is False
            assert result["adapter_execution_gate"]["implementation_enabled"] is False
            assert result["adapter_execution_gate"]["execute_enabled"] is False
            assert result["adapter_execution_gate"]["write_runner_enabled"] is False
            assert result["adapter_execution_gate"]["adapter_execution_enabled"] is False
            assert result["adapter_execution_gate"]["runner_invoked"] is False
            assert result["adapter_execution_gate"]["mutation_performed"] is False
            assert result["adapter_execution_gate"]["adapter_import_allowed"] is False
            assert result["adapter_execution_gate"]["adapter_execution_allowed"] is False
            assert result["adapter_execution_gate"]["wired_into_sdk_invoke"] is False
            assert result["adapter_execution_gate"]["adapter_runtime_wired"] is False
            assert result["adapter_execution_gate"]["execution_dry_run_invoked"] is False
...
class TestLocalClient:
    ...
    @pytest.mark.asyncio
    async def test_local_client_record_sdk_runtime_flag_application_adapter_design_review_not_implemented(self):
        """Test SDK runtime flag adapter design review recording is HTTP-only."""
        config = CLIConfig(mode="local")
        client = LocalClient(config)

        with pytest.raises(
            NotImplementedError,
            match="SDK runtime flag application adapter design review recording",
        ):
            await client.record_sdk_runtime_flag_application_adapter_design_review({"approval_id": "approval-1"})

    @pytest.mark.asyncio
    async def test_local_client_record_sdk_runtime_flag_application_adapter_implementation_preflight_not_implemented(self):
        """Test SDK runtime flag adapter implementation preflight recording is HTTP-only."""
        config = CLIConfig(mode="local")
        client = LocalClient(config)
    ...
    @pytest.mark.asyncio
    async def test_local_client_record_sdk_runtime_flag_application_adapter_wiring_not_implemented(self):
        """Test SDK runtime flag adapter wiring recording is HTTP-only."""
        config = CLIConfig(mode="local")
        client = LocalClient(config)

        with pytest.raises(
            NotImplementedError,
            match="SDK runtime flag application adapter wiring recording",
        ):
            await client.record_sdk_runtime_flag_application_adapter_wiring({"approval_id": "approval-1"})

    @pytest.mark.asyncio
    async def test_local_client_record_sdk_runtime_flag_application_adapter_runtime_preflight_not_implemented(self):
        """Test SDK runtime flag adapter runtime preflight recording is HTTP-only."""
        config = CLIConfig(mode="local")
        client = LocalClient(config)

        with pytest.raises(
            NotImplementedError,
            match="SDK runtime flag application adapter runtime preflight recording",
        ):
            await client.record_sdk_runtime_flag_application_adapter_runtime_preflight({"approval_id": "approval-1"})

    @pytest.mark.asyncio
    async def test_local_client_record_sdk_runtime_flag_application_adapter_execution_dry_run_not_implemented(self):
        """Test SDK runtime flag adapter execution dry-run recording is HTTP-only."""
        config = CLIConfig(mode="local")
        client = LocalClient(config)

        with pytest.raises(
            NotImplementedError,
            match="SDK runtime flag application adapter execution dry-run recording",
        ):
            await client.record_sdk_runtime_flag_application_adapter_execution_dry_run({"approval_id": "approval-1"})

    @pytest.mark.asyncio
    async def test_local_client_record_sdk_runtime_flag_application_adapter_execution_gate_not_implemented(self):
        """Test SDK runtime flag adapter execution gate recording is HTTP-only."""
        config = CLIConfig(mode="local")
        client = LocalClient(config)
