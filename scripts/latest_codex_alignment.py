...
def _capabilities() -> list[CodexAlignmentCapability]:
    return [
        ...
        CodexAlignmentCapability(
            ...
            priority="P1",
            xagent_status="sdk_live_runtime_flag_application_adapter_wiring_workflow_ready",
            evidence=[
                "sdk_noninteractive_report",
                "sdk_contract_module",
                "sdk_cli_command",
            ...
            next_task="Add a separate owner-approved runtime preflight gate for the disabled live runtime flag application adapter; keep write-runner invocation as a later follow-up.",
