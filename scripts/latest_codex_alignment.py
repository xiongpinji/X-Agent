...
def _capabilities() -> list[CodexAlignmentCapability]:
    return [
        ...
        CodexAlignmentCapability(
            ...
            priority="P1",
            xagent_status="sdk_live_runtime_flag_application_readiness_plan_decision_workflow_ready",
            evidence=[
                "sdk_noninteractive_report",
                "sdk_contract_module",
                "sdk_cli_command",
            ...
            next_task="Implement the live runtime flag application adapter only after the readiness plan decision is owner-accepted and explicitly requested; keep write-runner wiring as a separate follow-up gate.",
