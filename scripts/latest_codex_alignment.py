...
READY_XAGENT_STATUSES = frozenset(
    {
        ...
        "sdk_live_runtime_flag_application_adapter_runtime_preflight_workflow_ready",
        "sdk_live_runtime_flag_application_adapter_wiring_workflow_ready",
        "sdk_live_runtime_flag_application_adapter_code_change_workflow_ready",
        "sdk_live_runtime_flag_application_adapter_implementation_preflight_workflow_ready",
        "sdk_live_runtime_flag_application_adapter_design_review_workflow_ready",
        "sdk_live_runtime_flag_application_adapter_implementation_request_workflow_ready",
        "sdk_live_runtime_flag_application_readiness_plan_decision_workflow_ready",
        "sdk_live_runtime_flag_application_implementation_readiness_plan_ready",
        "sdk_runtime_flag_application_execute_contract_owner_review_ready",
        "sdk_runtime_flag_application_execute_contract_workflow_ready",
        "sdk_runtime_flag_application_owner_approval_workflow_ready",
        "sdk_runtime_flag_application_preflight_workflow_ready",
        "sdk_runtime_flag_enablement_record_workflow_ready",
        "sdk_runtime_implementation_final_decision_workflow_ready",
        "sdk_runtime_implementation_owner_pack_ready",
        "sdk_runtime_implementation_readiness_lock_workflow_ready",
        "sdk_runtime_enablement_owner_pack_decision_workflow_ready",
        "sdk_runtime_enablement_owner_pack_ready",
        ...
        "sdk_write_runner_safety_contract_ready",
        "sdk_read_only_runner_contract_ready",
        "sdk_execution_adapter_contract_ready",
...
def _capabilities() -> list[CodexAlignmentCapability]:
    return [
        ...
        CodexAlignmentCapability(
            ...
            priority="P1",
            xagent_status="sdk_live_runtime_flag_application_adapter_execution_gate_workflow_ready",
            evidence=[
                "sdk_noninteractive_report",
                "sdk_contract_module",
                "sdk_cli_command",
            ...
            next_task="Add owner acceptance evidence for live SDK write-runner execution after execution-gate review; keep write-runner invocation disabled until explicit owner acceptance.",
