...
READY_XAGENT_STATUSES = frozenset(
    {
        ...
        "partial",
        "sdk_write_runner_owner_acceptance_contract_ready",
...
def build_evidence_specs(root: Path = ROOT, report_dir: Path = REPORT_DIR) -> tuple[AlignmentEvidenceSpec, ...]:
    return (
        ...
        AlignmentEvidenceSpec(
            ...
            "runtime_report",
            expected_statuses=frozenset({"sdk_write_runner_owner_acceptance_contract_ready"}),
...
def _capabilities() -> list[CodexAlignmentCapability]:
    return [
        ...
        CodexAlignmentCapability(
            ...
            priority="P1",
            xagent_status="sdk_write_runner_owner_acceptance_contract_ready",
            evidence=[
                "sdk_noninteractive_report",
                "sdk_contract_module",
                "sdk_cli_command",
            ...
            next_task="Add owner-controlled acceptance evidence creation/review workflow before enabling the concrete owner-approved write runner adapter.",
