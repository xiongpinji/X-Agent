...
def build_evidence_specs(root: Path = ROOT, report_dir: Path = REPORT_DIR) -> tuple[AlignmentEvidenceSpec, ...]:
    return (
        ...
        AlignmentEvidenceSpec(
            ...
            "runtime_report",
            expected_statuses=frozenset({"sdk_runtime_flag_application_execute_contract_owner_review_ready"}),
...
def _capabilities() -> list[CodexAlignmentCapability]:
    return [
        ...
        CodexAlignmentCapability(
            ...
            priority="P1",
            xagent_status="sdk_runtime_flag_application_execute_contract_owner_review_ready",
            evidence=[
                "sdk_noninteractive_report",
                "sdk_contract_module",
                "sdk_cli_command",
            ...
            next_task="Implement live runtime flag application only after the execute contract owner review is independently accepted and explicitly requested; keep write-runner wiring as a separate follow-up gate.",
