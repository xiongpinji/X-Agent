...
def _capabilities() -> list[CodexAlignmentCapability]:
    return [
        ...
        CodexAlignmentCapability(
            ...
            priority="P1",
            xagent_status="sdk_live_runtime_flag_application_adapter_implementation_preflight_workflow_ready",
            evidence=[
                "sdk_noninteractive_report",
                "sdk_contract_module",
                "sdk_cli_command",
            ...
            next_task="Implement the owner-approved live runtime flag application adapter code change only after accepted implementation preflight is recorded; keep write-runner wiring as a separate follow-up gate.",
