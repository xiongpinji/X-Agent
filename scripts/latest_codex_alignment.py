...
def build_evidence_specs(root: Path = ROOT, report_dir: Path = REPORT_DIR) -> tuple[AlignmentEvidenceSpec, ...]:
    return (
        ...
        AlignmentEvidenceSpec(
            ...
            "runtime_report",
            expected_statuses=frozenset({"sdk_runtime_enablement_receipt_contract_ready"}),
...
def _capabilities() -> list[CodexAlignmentCapability]:
    return [
        ...
        CodexAlignmentCapability(
            ...
            priority="P1",
            xagent_status="sdk_runtime_enablement_receipt_contract_ready",
            evidence=[
                "sdk_noninteractive_report",
                "sdk_contract_module",
                "sdk_cli_command",
            ...
            next_task="Implement the runtime write-runner behind XAGENT_SDK_WRITE_RUNNER_ENABLED only after readiness receipt owner review is accepted.",
