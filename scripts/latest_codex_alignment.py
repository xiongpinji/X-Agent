...
def _capabilities() -> list[CodexAlignmentCapability]:
    return [
        ...
        CodexAlignmentCapability(
            ...
            priority="P1",
            xagent_status="sdk_live_runtime_flag_application_adapter_execution_dry_run_workflow_ready",
            evidence=[
                "sdk_noninteractive_report",
                "sdk_contract_module",
                "sdk_cli_command",
            ...
            next_task="Add a separate owner-approved live adapter execution gate after dry-run evidence review; keep write-runner invocation disabled until owner acceptance.",
