...
def _build_checks(report_payload: dict[str, Any]) -> list[SDKNonInteractiveCheck]:
    ...
    return [
        SDKNonInteractiveCheck(
            ...
            error=None if len(methods) == 24 else "SDK methods are incomplete",
        ),
        SDKNonInteractiveCheck(
...
def main() -> int:
    ...
    return 0 if report.status == "sdk_live_runtime_flag_application_adapter_runtime_preflight_workflow_ready" else 1
