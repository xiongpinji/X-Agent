...
class SDKNonInteractiveReport:
    ...
    live_runtime_flag_application_adapter_implementation_preflight_workflow: dict[str, Any]
    live_runtime_flag_application_adapter_module_contract: dict[str, Any]
    live_runtime_flag_application_adapter_code_change_workflow: dict[str, Any]
    ...
    live_write_runner_invocation_review_workflow: dict[str, Any]
...
def _sdk_contracts() -> list[dict[str, Any]]:
    ...
    return [
        ...
        sdk.record_runtime_flag_application_adapter_implementation_request(
            ...
            requested_by="<owner>",
            requested_at="2026-06-08T00:00:00Z",
            implementation_request_reason="<reason>",
        ...
        sdk.record_runtime_flag_application_adapter_implementation_preflight(
        ...
        sdk.record_runtime_flag_application_adapter_code_change(
        ...
        sdk.record_runtime_flag_application_adapter_wiring(
        ...
        sdk.record_runtime_flag_application_adapter_runtime_preflight(
            ...
            final_decision_id="<final_decision_id>",
            operator_id="<operator>",
            preflighted_at="2026-06-08T00:00:00Z",
        ...
        sdk.record_runtime_flag_application_adapter_execution_dry_run(
            ...
            final_decision_id="<final_decision_id>",
            operator_id="<operator>",
            dry_run_started_at="2026-06-08T00:00:00Z",
        ...
        sdk.record_live_write_runner_invocation_review(
...
def _cli_commands() -> list[dict[str, Any]]:
    return [
        ...
        {
            "command": "xagent sdk runtime-flag-application-adapter-implementation-request-record --adapter-implementation-request-id <adapter_implementation_request_id> --readiness-plan-decision-id <readiness_plan_decision_id> --readiness-plan-decision-audit-id <readiness_plan_decision_audit_id> --execute",
            "method": "runtime_flag_application_adapter_implementation_request_record",
            "non_interactive": True,
            "dry_run_default": True,
        ...
        {
            "command": "xagent sdk runtime-flag-application-adapter-implementation-preflight-record --adapter-implementation-preflight-id <adapter_implementation_preflight_id> --adapter-design-review-id <adapter_design_review_id> --adapter-design-review-audit-id <adapter_design_review_audit_id> --execute",
            "method": "runtime_flag_application_adapter_implementation_preflight_record",
            "non_interactive": True,
            "dry_run_default": True,
            "execute_target": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/implementation-preflight/record",
            "execute_starts_agent": False,
        },
        {
            "command": "xagent sdk runtime-flag-application-adapter-code-change-record --adapter-code-change-id <adapter_code_change_id> --adapter-implementation-preflight-id <adapter_implementation_preflight_id> --adapter-implementation-preflight-audit-id <adapter_implementation_preflight_audit_id> --execute",
            "method": "runtime_flag_application_adapter_code_change_record",
            "non_interactive": True,
            "dry_run_default": True,
            "execute_target": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/code-change/record",
            "execute_starts_agent": False,
        },
        {
            "command": "xagent sdk runtime-flag-application-adapter-wiring-record --adapter-wiring-id <adapter_wiring_id> --adapter-code-change-id <adapter_code_change_id> --adapter-code-change-audit-id <adapter_code_change_audit_id> --execute",
            "method": "runtime_flag_application_adapter_wiring_record",
            "non_interactive": True,
            "dry_run_default": True,
            "execute_target": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/wiring/record",
            "execute_starts_agent": False,
        },
        {
            "command": "xagent sdk runtime-flag-application-adapter-runtime-preflight-record --adapter-runtime-preflight-id <adapter_runtime_preflight_id> --adapter-wiring-id <adapter_wiring_id> --adapter-wiring-audit-id <adapter_wiring_audit_id> --execute",
            "method": "runtime_flag_application_adapter_runtime_preflight_record",
            "non_interactive": True,
            "dry_run_default": True,
            "execute_target": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/runtime-preflight/record",
            "execute_starts_agent": False,
        },
        {
            "command": "xagent sdk runtime-flag-application-adapter-execution-dry-run-record --adapter-execution-dry-run-id <adapter_execution_dry_run_id> --adapter-runtime-preflight-id <adapter_runtime_preflight_id> --adapter-runtime-preflight-audit-id <adapter_runtime_preflight_audit_id> --execute",
            "method": "runtime_flag_application_adapter_execution_dry_run_record",
            "non_interactive": True,
            "dry_run_default": True,
        ...
        {
            "command": "xagent sdk live-write-runner-invocation-review-record --invocation-review-id <invocation_review_id> --execution-acceptance-id <execution_acceptance_id> --execution-acceptance-audit-id <execution_acceptance_audit_id> --execute",
            "method": "live_write_runner_invocation_review_record",
            "non_interactive": True,
            "dry_run_default": True,
            "execute_target": "/api/v1/control-plane/sdk/live-write-runner/invocation-review/record",
            "execute_starts_agent": False,
        },
    ]
...
def _build_checks(report_payload: dict[str, Any]) -> list[SDKNonInteractiveCheck]:
    ...
    live_flag_adapter_implementation_preflight = report_payload[
        "live_runtime_flag_application_adapter_implementation_preflight_workflow"
    ]
    live_flag_adapter_module = report_payload[
        "live_runtime_flag_application_adapter_module_contract"
    ]
    live_flag_adapter_code_change = report_payload[
        "live_runtime_flag_application_adapter_code_change_workflow"
    ]
    live_flag_adapter_wiring = report_payload[
        "live_runtime_flag_application_adapter_wiring_workflow"
    ]
    live_flag_adapter_runtime_preflight = report_payload[
        "live_runtime_flag_application_adapter_runtime_preflight_workflow"
    ]
    ...
    live_write_runner_invocation_review = report_payload[
        "live_write_runner_invocation_review_workflow"
    ]
    ...
    return [
        SDKNonInteractiveCheck(
            ...
            == [
                ...
                "live_write_runner_invocation_review_record",
            ]
            else "failed",
            details={"methods": methods},
            error=None if len(methods) == 28 else "SDK methods are incomplete",
        ),
        SDKNonInteractiveCheck(
        ...
        SDKNonInteractiveCheck(
            name="live_runtime_flag_application_adapter_implementation_request_workflow_ready",
            status="passed"
            if live_flag_adapter_implementation_request.get("stage")
            == "runtime_flag_application_adapter_implementation_request_workflow"
            and live_flag_adapter_implementation_request.get("workflow_status") == "ready_but_disabled"
            and live_flag_adapter_implementation_request.get("endpoint")
            == "/api/v1/control-plane/sdk/runtime-flag/application-adapter/implementation-request/record"
            and live_flag_adapter_implementation_request.get("audit_action")
            == "sdk.write_runner.runtime_flag_application_adapter_implementation_request_recorded"
            and live_flag_adapter_implementation_request.get("requires_approved_sdk_approval") is True
            and live_flag_adapter_implementation_request.get("requires_accepted_readiness_plan_decision")
            is True
            and live_flag_adapter_implementation_request.get("requires_readiness_plan_decision_audit")
            is True
            and live_flag_adapter_implementation_request.get("requires_runtime_flag_name")
            == "XAGENT_SDK_WRITE_RUNNER_ENABLED"
            and live_flag_adapter_implementation_request.get("requires_adapter_design_ref") is True
            and live_flag_adapter_implementation_request.get("requires_rollback_plan_ref") is True
            and live_flag_adapter_implementation_request.get("requires_smoke_runbook_ref") is True
            and live_flag_adapter_implementation_request.get("requires_signature_or_hash") is True
            and live_flag_adapter_implementation_request.get("request_effect", {}).get(
                "implements_adapter"
            )
            is False
            and live_flag_adapter_implementation_request.get("request_effect", {}).get(
            ...
            is False
            and live_flag_adapter_implementation_request.get("implementation_enabled") is False
            and live_flag_adapter_implementation_request.get("runtime_flag_enabled") is False
            and live_flag_adapter_implementation_request.get("flag_application_performed") is False
            and live_flag_adapter_implementation_request.get("execute_enabled") is False
            and live_flag_adapter_implementation_request.get("write_runner_enabled") is False
            and live_flag_adapter_implementation_request.get("adapter_execution_enabled") is False
            and live_flag_adapter_implementation_request.get("agent_execution_enabled") is False
            and live_flag_adapter_implementation_request.get("runner_invoked") is False
            and live_flag_adapter_implementation_request.get("mark_executed") is False
            and live_flag_adapter_implementation_request.get("mutation_performed") is False
            and live_flag_adapter_implementation_request.get("adapter_import_allowed") is False
            and live_flag_adapter_implementation_request.get("adapter_execution_allowed") is False
            else "failed",
            details=live_flag_adapter_implementation_request,
            error=None
            if live_flag_adapter_implementation_request.get("workflow_status") == "ready_but_disabled"
        ...
        SDKNonInteractiveCheck(
            name="live_runtime_flag_application_adapter_implementation_preflight_workflow_ready",
            status="passed"
            if live_flag_adapter_implementation_preflight.get("stage")
            == "runtime_flag_application_adapter_implementation_preflight_workflow"
            and live_flag_adapter_implementation_preflight.get("workflow_status") == "ready_but_disabled"
            and live_flag_adapter_implementation_preflight.get("endpoint")
            == "/api/v1/control-plane/sdk/runtime-flag/application-adapter/implementation-preflight/record"
            and live_flag_adapter_implementation_preflight.get("audit_action")
            == "sdk.write_runner.runtime_flag_application_adapter_implementation_preflight_recorded"
            and live_flag_adapter_implementation_preflight.get("requires_approved_sdk_approval") is True
            and live_flag_adapter_implementation_preflight.get("requires_accepted_adapter_design_review")
            is True
            and live_flag_adapter_implementation_preflight.get("requires_adapter_design_review_audit")
            is True
            and live_flag_adapter_implementation_preflight.get("requires_runtime_flag_name")
            == "XAGENT_SDK_WRITE_RUNNER_ENABLED"
            and live_flag_adapter_implementation_preflight.get("requires_implementation_branch_ref")
            is True
            and live_flag_adapter_implementation_preflight.get("requires_implementation_plan_ref")
            is True
            and live_flag_adapter_implementation_preflight.get("requires_adapter_design_ref") is True
            and live_flag_adapter_implementation_preflight.get("requires_security_review_ref") is True
            and live_flag_adapter_implementation_preflight.get("requires_test_plan_ref") is True
            and live_flag_adapter_implementation_preflight.get("requires_rollback_plan_ref") is True
            and live_flag_adapter_implementation_preflight.get("requires_smoke_runbook_ref") is True
            and live_flag_adapter_implementation_preflight.get("requires_idempotency_key") is True
            and live_flag_adapter_implementation_preflight.get("requires_idempotency_hash") is True
            and live_flag_adapter_implementation_preflight.get("requires_signature_or_hash") is True
            and live_flag_adapter_implementation_preflight.get("preflight_effect", {}).get(
                "implements_adapter"
            )
            is False
            and live_flag_adapter_implementation_preflight.get("preflight_effect", {}).get(
            ...
            is False
            and live_flag_adapter_implementation_preflight.get("implementation_enabled") is False
            and live_flag_adapter_implementation_preflight.get("runtime_flag_enabled") is False
            and live_flag_adapter_implementation_preflight.get("flag_application_performed") is False
            and live_flag_adapter_implementation_preflight.get("execute_enabled") is False
            and live_flag_adapter_implementation_preflight.get("write_runner_enabled") is False
            and live_flag_adapter_implementation_preflight.get("adapter_execution_enabled") is False
            and live_flag_adapter_implementation_preflight.get("agent_execution_enabled") is False
            and live_flag_adapter_implementation_preflight.get("runner_invoked") is False
            and live_flag_adapter_implementation_preflight.get("mark_executed") is False
            and live_flag_adapter_implementation_preflight.get("mutation_performed") is False
            and live_flag_adapter_implementation_preflight.get("file_mutation_performed") is False
            and live_flag_adapter_implementation_preflight.get("adapter_import_allowed") is False
            and live_flag_adapter_implementation_preflight.get("adapter_execution_allowed") is False
            else "failed",
            details=live_flag_adapter_implementation_preflight,
            error=None
            if live_flag_adapter_implementation_preflight.get("workflow_status") == "ready_but_disabled"
            else "live runtime flag application adapter implementation preflight workflow is not ready but disabled",
        ),
        SDKNonInteractiveCheck(
            name="live_runtime_flag_application_adapter_module_contract_ready",
            status="passed"
            if live_flag_adapter_module.get("module") == "backend.app.sdk.runtime_flag_application_adapter"
            and live_flag_adapter_module.get("class") == "SDKRuntimeFlagApplicationAdapter"
            and live_flag_adapter_module.get("available") is True
            and live_flag_adapter_module.get("wired_into_sdk_invoke") is False
            and live_flag_adapter_module.get("runtime_flag_enabled") is False
            and live_flag_adapter_module.get("adapter_execution_enabled") is False
            and live_flag_adapter_module.get("runner_invoked") is False
            and live_flag_adapter_module.get("mutation_performed") is False
            else "failed",
            details=live_flag_adapter_module,
            error=None
            if live_flag_adapter_module.get("available") is True
            else "live runtime flag application adapter module contract is not available",
        ),
        SDKNonInteractiveCheck(
            name="live_runtime_flag_application_adapter_code_change_workflow_ready",
            status="passed"
            if live_flag_adapter_code_change.get("stage")
            == "runtime_flag_application_adapter_code_change_workflow"
            and live_flag_adapter_code_change.get("workflow_status") == "ready_but_disabled"
            and live_flag_adapter_code_change.get("endpoint")
            == "/api/v1/control-plane/sdk/runtime-flag/application-adapter/code-change/record"
            and live_flag_adapter_code_change.get("audit_action")
            == "sdk.write_runner.runtime_flag_application_adapter_code_change_recorded"
            and live_flag_adapter_code_change.get("requires_approved_sdk_approval") is True
            and live_flag_adapter_code_change.get("requires_accepted_adapter_implementation_preflight")
            is True
            and live_flag_adapter_code_change.get("requires_adapter_implementation_preflight_audit")
            is True
            and live_flag_adapter_code_change.get("requires_adapter_module")
            == "backend.app.sdk.runtime_flag_application_adapter"
            and live_flag_adapter_code_change.get("requires_adapter_class")
            == "SDKRuntimeFlagApplicationAdapter"
            and live_flag_adapter_code_change.get("code_change_effect", {}).get("adapter_module_added")
            is True
            and live_flag_adapter_code_change.get("code_change_effect", {}).get("adapter_runtime_wired")
            is False
            and live_flag_adapter_code_change.get("code_change_effect", {}).get("imports_adapter_in_sdk_invoke")
            is False
            and live_flag_adapter_code_change.get("code_change_effect", {}).get("invokes_write_runner")
            is False
            and live_flag_adapter_code_change.get("implementation_enabled") is False
            and live_flag_adapter_code_change.get("runtime_flag_enabled") is False
            and live_flag_adapter_code_change.get("flag_application_performed") is False
            and live_flag_adapter_code_change.get("write_runner_enabled") is False
            and live_flag_adapter_code_change.get("adapter_execution_enabled") is False
            and live_flag_adapter_code_change.get("agent_execution_enabled") is False
            and live_flag_adapter_code_change.get("runner_invoked") is False
            and live_flag_adapter_code_change.get("mutation_performed") is False
            and live_flag_adapter_code_change.get("file_mutation_performed") is False
            and live_flag_adapter_code_change.get("adapter_import_allowed") is False
            and live_flag_adapter_code_change.get("adapter_execution_allowed") is False
            else "failed",
            details=live_flag_adapter_code_change,
            error=None
            if live_flag_adapter_code_change.get("workflow_status") == "ready_but_disabled"
            else "live runtime flag application adapter code-change workflow is not ready but disabled",
        ),
        SDKNonInteractiveCheck(
            name="live_runtime_flag_application_adapter_wiring_workflow_ready",
            status="passed"
            if live_flag_adapter_wiring.get("stage") == "runtime_flag_application_adapter_wiring_workflow"
            and live_flag_adapter_wiring.get("workflow_status") == "ready_but_disabled"
            and live_flag_adapter_wiring.get("endpoint")
            == "/api/v1/control-plane/sdk/runtime-flag/application-adapter/wiring/record"
            and live_flag_adapter_wiring.get("audit_action")
            == "sdk.write_runner.runtime_flag_application_adapter_wiring_recorded"
            and live_flag_adapter_wiring.get("requires_approved_sdk_approval") is True
            and live_flag_adapter_wiring.get("requires_accepted_adapter_code_change") is True
            and live_flag_adapter_wiring.get("requires_adapter_code_change_audit") is True
            and live_flag_adapter_wiring.get("requires_adapter_module")
            == "backend.app.sdk.runtime_flag_application_adapter"
            and live_flag_adapter_wiring.get("requires_adapter_class") == "SDKRuntimeFlagApplicationAdapter"
            and live_flag_adapter_wiring.get("wiring_effect", {}).get("wiring_recorded") is True
            and live_flag_adapter_wiring.get("wiring_effect", {}).get("wired_into_sdk_invoke") is False
            and live_flag_adapter_wiring.get("wiring_effect", {}).get("adapter_runtime_wired") is False
            and live_flag_adapter_wiring.get("wiring_effect", {}).get("imports_adapter_in_sdk_invoke") is False
            and live_flag_adapter_wiring.get("wiring_effect", {}).get("instantiates_adapter_in_sdk_invoke")
            is False
            and live_flag_adapter_wiring.get("wiring_effect", {}).get("invokes_write_runner") is False
            and live_flag_adapter_wiring.get("implementation_enabled") is False
            and live_flag_adapter_wiring.get("runtime_flag_enabled") is False
            and live_flag_adapter_wiring.get("flag_application_performed") is False
            and live_flag_adapter_wiring.get("write_runner_enabled") is False
            and live_flag_adapter_wiring.get("adapter_execution_enabled") is False
            and live_flag_adapter_wiring.get("agent_execution_enabled") is False
            and live_flag_adapter_wiring.get("runner_invoked") is False
            and live_flag_adapter_wiring.get("mutation_performed") is False
            and live_flag_adapter_wiring.get("file_mutation_performed") is False
            and live_flag_adapter_wiring.get("adapter_import_allowed") is False
            and live_flag_adapter_wiring.get("adapter_execution_allowed") is False
            and live_flag_adapter_wiring.get("wired_into_sdk_invoke") is False
            and live_flag_adapter_wiring.get("adapter_runtime_wired") is False
            else "failed",
            details=live_flag_adapter_wiring,
            error=None
            if live_flag_adapter_wiring.get("workflow_status") == "ready_but_disabled"
            else "live runtime flag application adapter wiring workflow is not ready but disabled",
        ),
        SDKNonInteractiveCheck(
            name="live_runtime_flag_application_adapter_runtime_preflight_workflow_ready",
            status="passed"
            if live_flag_adapter_runtime_preflight.get("stage")
            == "runtime_flag_application_adapter_runtime_preflight_workflow"
            and live_flag_adapter_runtime_preflight.get("workflow_status") == "ready_but_disabled"
            and live_flag_adapter_runtime_preflight.get("endpoint")
            == "/api/v1/control-plane/sdk/runtime-flag/application-adapter/runtime-preflight/record"
            and live_flag_adapter_runtime_preflight.get("audit_action")
            == "sdk.write_runner.runtime_flag_application_adapter_runtime_preflight_recorded"
            and live_flag_adapter_runtime_preflight.get("requires_approved_sdk_approval") is True
            and live_flag_adapter_runtime_preflight.get("requires_accepted_adapter_wiring") is True
            and live_flag_adapter_runtime_preflight.get("requires_adapter_wiring_audit") is True
            and live_flag_adapter_runtime_preflight.get("requires_adapter_module")
            == "backend.app.sdk.runtime_flag_application_adapter"
            and live_flag_adapter_runtime_preflight.get("requires_adapter_class")
            == "SDKRuntimeFlagApplicationAdapter"
            and live_flag_adapter_runtime_preflight.get("requires_runtime_preflight_plan_ref") is True
            and live_flag_adapter_runtime_preflight.get("runtime_preflight_effect", {}).get(
            ...
            is False
            and live_flag_adapter_runtime_preflight.get("implementation_enabled") is False
            and live_flag_adapter_runtime_preflight.get("runtime_flag_enabled") is False
            and live_flag_adapter_runtime_preflight.get("flag_application_performed") is False
            and live_flag_adapter_runtime_preflight.get("write_runner_enabled") is False
            and live_flag_adapter_runtime_preflight.get("adapter_execution_enabled") is False
            and live_flag_adapter_runtime_preflight.get("agent_execution_enabled") is False
            and live_flag_adapter_runtime_preflight.get("runner_invoked") is False
            and live_flag_adapter_runtime_preflight.get("mutation_performed") is False
            and live_flag_adapter_runtime_preflight.get("file_mutation_performed") is False
            and live_flag_adapter_runtime_preflight.get("adapter_import_allowed") is False
            and live_flag_adapter_runtime_preflight.get("adapter_execution_allowed") is False
            and live_flag_adapter_runtime_preflight.get("wired_into_sdk_invoke") is False
            and live_flag_adapter_runtime_preflight.get("adapter_runtime_wired") is False
            else "failed",
            details=live_flag_adapter_runtime_preflight,
            error=None
            if live_flag_adapter_runtime_preflight.get("workflow_status") == "ready_but_disabled"
            else "live runtime flag application adapter runtime preflight workflow is not ready but disabled",
        ),
        SDKNonInteractiveCheck(
            name="live_runtime_flag_application_adapter_execution_dry_run_workflow_ready",
            status="passed"
            if live_flag_adapter_execution_dry_run.get("stage")
            == "runtime_flag_application_adapter_execution_dry_run_workflow"
            and live_flag_adapter_execution_dry_run.get("workflow_status") == "ready_but_disabled"
            and live_flag_adapter_execution_dry_run.get("endpoint")
            == "/api/v1/control-plane/sdk/runtime-flag/application-adapter/execution-dry-run/record"
            and live_flag_adapter_execution_dry_run.get("audit_action")
            == "sdk.write_runner.runtime_flag_application_adapter_execution_dry_run_recorded"
            and live_flag_adapter_execution_dry_run.get("requires_approved_sdk_approval") is True
            and live_flag_adapter_execution_dry_run.get("requires_accepted_adapter_runtime_preflight")
            is True
            and live_flag_adapter_execution_dry_run.get("requires_adapter_runtime_preflight_audit")
            is True
            and live_flag_adapter_execution_dry_run.get("requires_adapter_module")
            == "backend.app.sdk.runtime_flag_application_adapter"
            and live_flag_adapter_execution_dry_run.get("requires_adapter_class")
            == "SDKRuntimeFlagApplicationAdapter"
            and live_flag_adapter_execution_dry_run.get("requires_execution_dry_run_plan_ref") is True
            and live_flag_adapter_execution_dry_run.get("execution_dry_run_effect", {}).get(
            ...
            is False
            and live_flag_adapter_execution_dry_run.get("implementation_enabled") is False
            and live_flag_adapter_execution_dry_run.get("runtime_flag_enabled") is False
            and live_flag_adapter_execution_dry_run.get("flag_application_performed") is False
            and live_flag_adapter_execution_dry_run.get("write_runner_enabled") is False
            and live_flag_adapter_execution_dry_run.get("adapter_execution_enabled") is False
            and live_flag_adapter_execution_dry_run.get("agent_execution_enabled") is False
            and live_flag_adapter_execution_dry_run.get("runner_invoked") is False
            and live_flag_adapter_execution_dry_run.get("mutation_performed") is False
            and live_flag_adapter_execution_dry_run.get("file_mutation_performed") is False
            and live_flag_adapter_execution_dry_run.get("adapter_import_allowed") is False
            and live_flag_adapter_execution_dry_run.get("adapter_execution_allowed") is False
            and live_flag_adapter_execution_dry_run.get("wired_into_sdk_invoke") is False
            and live_flag_adapter_execution_dry_run.get("adapter_runtime_wired") is False
            and live_flag_adapter_execution_dry_run.get("execution_dry_run_invoked") is False
            else "failed",
            details=live_flag_adapter_execution_dry_run,
            error=None
            if live_flag_adapter_execution_dry_run.get("workflow_status") == "ready_but_disabled"
        ...
        SDKNonInteractiveCheck(
            name="live_write_runner_invocation_review_workflow_ready",
            status="passed"
            if live_write_runner_invocation_review.get("stage")
            == "live_write_runner_invocation_review_workflow"
            and live_write_runner_invocation_review.get("workflow_status") == "ready_but_disabled"
            and live_write_runner_invocation_review.get("endpoint")
            == "/api/v1/control-plane/sdk/live-write-runner/invocation-review/record"
            and live_write_runner_invocation_review.get("audit_action")
            == "sdk.write_runner.live_write_runner_invocation_review_recorded"
            and live_write_runner_invocation_review.get("requires_approved_sdk_approval") is True
            and live_write_runner_invocation_review.get("requires_accepted_execution_acceptance")
            is True
            and live_write_runner_invocation_review.get("requires_execution_acceptance_audit")
            is True
            and live_write_runner_invocation_review.get("requires_adapter_module")
            == "backend.app.sdk.runtime_flag_application_adapter"
            and live_write_runner_invocation_review.get("requires_adapter_class")
            == "SDKRuntimeFlagApplicationAdapter"
            and live_write_runner_invocation_review.get("requires_invocation_review_plan_ref")
            is True
            and live_write_runner_invocation_review.get("requires_execution_acceptance_plan_ref")
            is True
            and live_write_runner_invocation_review.get("requires_runbook_acknowledged") is True
            and live_write_runner_invocation_review.get("requires_rollback_plan_acknowledged")
            is True
            and live_write_runner_invocation_review.get("requires_smoke_runbook_acknowledged")
            is True
            and live_write_runner_invocation_review.get("invocation_review_effect", {}).get(
                "invocation_review_recorded"
            )
            is True
            and live_write_runner_invocation_review.get("invocation_review_effect", {}).get(
                "execution_gate_opened"
            ...
            is False
            and live_write_runner_invocation_review.get("implementation_enabled") is False
            and live_write_runner_invocation_review.get("runtime_flag_enabled") is False
            and live_write_runner_invocation_review.get("flag_application_performed") is False
            and live_write_runner_invocation_review.get("write_runner_enabled") is False
            and live_write_runner_invocation_review.get("adapter_execution_enabled") is False
            and live_write_runner_invocation_review.get("agent_execution_enabled") is False
            and live_write_runner_invocation_review.get("runner_invoked") is False
            and live_write_runner_invocation_review.get("write_runner_invoked") is False
            and live_write_runner_invocation_review.get("live_execution_started") is False
            and live_write_runner_invocation_review.get("mutation_performed") is False
            and live_write_runner_invocation_review.get("file_mutation_performed") is False
            and live_write_runner_invocation_review.get("adapter_import_allowed") is False
            and live_write_runner_invocation_review.get("adapter_execution_allowed") is False
            and live_write_runner_invocation_review.get("wired_into_sdk_invoke") is False
            and live_write_runner_invocation_review.get("adapter_runtime_wired") is False
            and live_write_runner_invocation_review.get("execution_dry_run_invoked") is False
            and live_write_runner_invocation_review.get("execution_gate_opened") is False
            else "failed",
            details=live_write_runner_invocation_review,
            error=None
            if live_write_runner_invocation_review.get("workflow_status") == "ready_but_disabled"
            else "live write-runner invocation review workflow is not ready but disabled",
        ),
        SDKNonInteractiveCheck(
...
def build_sdk_noninteractive_report() -> SDKNonInteractiveReport:
    report_payload: dict[str, Any] = {
        ...
        "live_runtime_flag_application_adapter_module_contract": {
            "available": True,
            "module": "backend.app.sdk.runtime_flag_application_adapter",
            "class": "SDKRuntimeFlagApplicationAdapter",
            "input_model": "RuntimeFlagApplicationAdapterInput",
            "plan_model": "RuntimeFlagApplicationAdapterPlan",
        ...
        "known_limits": [
            ...
            "Live write-runner invocation review can be recorded, but it does not invoke adapter execution or the write runner.",
...
def render_markdown_report(report: SDKNonInteractiveReport) -> str:
    ...
    return (
        ...
        "## Live Runtime Flag Application Adapter Implementation Request Workflow\n\n"
        f"- Stage: `{report.live_runtime_flag_application_adapter_implementation_request_workflow['stage']}`\n"
        f"- Workflow status: `{report.live_runtime_flag_application_adapter_implementation_request_workflow['workflow_status']}`\n"
        f"- Endpoint: `{report.live_runtime_flag_application_adapter_implementation_request_workflow['endpoint']}`\n"
        f"- Audit action: `{report.live_runtime_flag_application_adapter_implementation_request_workflow['audit_action']}`\n"
        f"- Runtime flag enabled: `{report.live_runtime_flag_application_adapter_implementation_request_workflow['runtime_flag_enabled']}`\n"
        ...
        "## Live Runtime Flag Application Adapter Implementation Preflight Workflow\n\n"
        f"- Stage: `{report.live_runtime_flag_application_adapter_implementation_preflight_workflow['stage']}`\n"
        f"- Workflow status: `{report.live_runtime_flag_application_adapter_implementation_preflight_workflow['workflow_status']}`\n"
        f"- Endpoint: `{report.live_runtime_flag_application_adapter_implementation_preflight_workflow['endpoint']}`\n"
        f"- Audit action: `{report.live_runtime_flag_application_adapter_implementation_preflight_workflow['audit_action']}`\n"
        f"- Runtime flag enabled: `{report.live_runtime_flag_application_adapter_implementation_preflight_workflow['runtime_flag_enabled']}`\n"
        f"- Adapter import allowed: `{report.live_runtime_flag_application_adapter_implementation_preflight_workflow['adapter_import_allowed']}`\n"
        f"- Adapter execution allowed: `{report.live_runtime_flag_application_adapter_implementation_preflight_workflow['adapter_execution_allowed']}`\n"
        f"- Runner invoked: `{report.live_runtime_flag_application_adapter_implementation_preflight_workflow['runner_invoked']}`\n\n"
        "## Live Runtime Flag Application Adapter Module Contract\n\n"
        f"- Module: `{report.live_runtime_flag_application_adapter_module_contract['module']}`\n"
        f"- Class: `{report.live_runtime_flag_application_adapter_module_contract['class']}`\n"
        f"- Wired into sdk invoke: `{report.live_runtime_flag_application_adapter_module_contract['wired_into_sdk_invoke']}`\n"
        f"- Runtime flag enabled: `{report.live_runtime_flag_application_adapter_module_contract['runtime_flag_enabled']}`\n"
        f"- Runner invoked: `{report.live_runtime_flag_application_adapter_module_contract['runner_invoked']}`\n\n"
        "## Live Runtime Flag Application Adapter Code Change Workflow\n\n"
        f"- Stage: `{report.live_runtime_flag_application_adapter_code_change_workflow['stage']}`\n"
        f"- Workflow status: `{report.live_runtime_flag_application_adapter_code_change_workflow['workflow_status']}`\n"
        f"- Endpoint: `{report.live_runtime_flag_application_adapter_code_change_workflow['endpoint']}`\n"
        f"- Audit action: `{report.live_runtime_flag_application_adapter_code_change_workflow['audit_action']}`\n"
        f"- Runtime flag enabled: `{report.live_runtime_flag_application_adapter_code_change_workflow['runtime_flag_enabled']}`\n"
        f"- Adapter import allowed: `{report.live_runtime_flag_application_adapter_code_change_workflow['adapter_import_allowed']}`\n"
        f"- Adapter execution allowed: `{report.live_runtime_flag_application_adapter_code_change_workflow['adapter_execution_allowed']}`\n"
        f"- Runner invoked: `{report.live_runtime_flag_application_adapter_code_change_workflow['runner_invoked']}`\n\n"
        "## Live Runtime Flag Application Adapter Wiring Workflow\n\n"
        f"- Stage: `{report.live_runtime_flag_application_adapter_wiring_workflow['stage']}`\n"
        f"- Workflow status: `{report.live_runtime_flag_application_adapter_wiring_workflow['workflow_status']}`\n"
        f"- Endpoint: `{report.live_runtime_flag_application_adapter_wiring_workflow['endpoint']}`\n"
        f"- Audit action: `{report.live_runtime_flag_application_adapter_wiring_workflow['audit_action']}`\n"
        f"- Wired into sdk invoke: `{report.live_runtime_flag_application_adapter_wiring_workflow['wired_into_sdk_invoke']}`\n"
        f"- Adapter runtime wired: `{report.live_runtime_flag_application_adapter_wiring_workflow['adapter_runtime_wired']}`\n"
        f"- Adapter execution allowed: `{report.live_runtime_flag_application_adapter_wiring_workflow['adapter_execution_allowed']}`\n"
        f"- Runner invoked: `{report.live_runtime_flag_application_adapter_wiring_workflow['runner_invoked']}`\n\n"
        "## Live Runtime Flag Application Adapter Runtime Preflight Workflow\n\n"
        f"- Stage: `{report.live_runtime_flag_application_adapter_runtime_preflight_workflow['stage']}`\n"
        f"- Workflow status: `{report.live_runtime_flag_application_adapter_runtime_preflight_workflow['workflow_status']}`\n"
        f"- Endpoint: `{report.live_runtime_flag_application_adapter_runtime_preflight_workflow['endpoint']}`\n"
        f"- Audit action: `{report.live_runtime_flag_application_adapter_runtime_preflight_workflow['audit_action']}`\n"
        f"- Wired into sdk invoke: `{report.live_runtime_flag_application_adapter_runtime_preflight_workflow['wired_into_sdk_invoke']}`\n"
        f"- Adapter runtime wired: `{report.live_runtime_flag_application_adapter_runtime_preflight_workflow['adapter_runtime_wired']}`\n"
        f"- Adapter execution allowed: `{report.live_runtime_flag_application_adapter_runtime_preflight_workflow['adapter_execution_allowed']}`\n"
        f"- Runner invoked: `{report.live_runtime_flag_application_adapter_runtime_preflight_workflow['runner_invoked']}`\n\n"
        "## Live Runtime Flag Application Adapter Execution Dry-Run Workflow\n\n"
        f"- Stage: `{report.live_runtime_flag_application_adapter_execution_dry_run_workflow['stage']}`\n"
        f"- Workflow status: `{report.live_runtime_flag_application_adapter_execution_dry_run_workflow['workflow_status']}`\n"
        f"- Endpoint: `{report.live_runtime_flag_application_adapter_execution_dry_run_workflow['endpoint']}`\n"
        f"- Audit action: `{report.live_runtime_flag_application_adapter_execution_dry_run_workflow['audit_action']}`\n"
        f"- Wired into sdk invoke: `{report.live_runtime_flag_application_adapter_execution_dry_run_workflow['wired_into_sdk_invoke']}`\n"
        f"- Adapter runtime wired: `{report.live_runtime_flag_application_adapter_execution_dry_run_workflow['adapter_runtime_wired']}`\n"
        ...
        "## Live Write Runner Invocation Review Workflow\n\n"
        f"- Stage: `{report.live_write_runner_invocation_review_workflow['stage']}`\n"
        f"- Workflow status: `{report.live_write_runner_invocation_review_workflow['workflow_status']}`\n"
        f"- Endpoint: `{report.live_write_runner_invocation_review_workflow['endpoint']}`\n"
        f"- Audit action: `{report.live_write_runner_invocation_review_workflow['audit_action']}`\n"
        f"- Wired into sdk invoke: `{report.live_write_runner_invocation_review_workflow['wired_into_sdk_invoke']}`\n"
        f"- Adapter runtime wired: `{report.live_write_runner_invocation_review_workflow['adapter_runtime_wired']}`\n"
        f"- Adapter execution allowed: `{report.live_write_runner_invocation_review_workflow['adapter_execution_allowed']}`\n"
        f"- Execution gate opened: `{report.live_write_runner_invocation_review_workflow['execution_gate_opened']}`\n"
        f"- Write runner invoked: `{report.live_write_runner_invocation_review_workflow['write_runner_invoked']}`\n"
        f"- Live execution started: `{report.live_write_runner_invocation_review_workflow['live_execution_started']}`\n\n"
        "## Channel Strategy\n\n"
...
def main() -> int:
    ...
    return 0 if report.status == "sdk_live_write_runner_invocation_review_workflow_ready" else 1
