...
class SDKRuntimeFlagApplicationPreflightRecordRequest(BaseModel):
    runtime_flag_preflight_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_enablement_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_enablement_audit_id: str = Field(..., min_length=1, max_length=240)
    final_decision_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_name: str = Field(..., min_length=1, max_length=240)
    target_state: str = Field(..., min_length=1, max_length=20)
    requested_by: str = Field(..., min_length=1, max_length=240)
    requested_at: str = Field(..., min_length=1, max_length=80)
    preflight_reason: str = Field(..., min_length=1, max_length=1000)
...
class SDKRuntimeFlagApplicationPreflightRecordResponse(BaseModel):
    ok: bool
    status: str
    runtime_flag_preflight: dict[str, Any]
    evidence: ControlPlaneEvidence


class SDKRuntimeFlagApplicationOwnerApprovalRecordRequest(BaseModel):
    runtime_flag_approval_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_preflight_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_preflight_audit_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_enablement_id: str = Field(..., min_length=1, max_length=240)
    final_decision_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_name: str = Field(..., min_length=1, max_length=240)
    decision: str = Field(..., min_length=1, max_length=20)
    ...
    approval_signature: str | None = Field(default=None, max_length=500)
    approval_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationOwnerApprovalRecordResponse(BaseModel):
    ok: bool
    status: str
    runtime_flag_approval: dict[str, Any]
    evidence: ControlPlaneEvidence


class SDKRuntimeFlagApplicationExecuteContractRecordRequest(BaseModel):
    runtime_flag_execute_contract_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_approval_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_approval_audit_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_preflight_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_enablement_id: str = Field(..., min_length=1, max_length=240)
    final_decision_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_name: str = Field(..., min_length=1, max_length=240)
    operator_id: str = Field(..., min_length=1, max_length=240)
    locked_at: str = Field(..., min_length=1, max_length=80)
    execute_contract_reason: str = Field(..., min_length=1, max_length=1000)
    idempotency_key: str = Field(..., min_length=1, max_length=500)
    idempotency_hash: str = Field(..., min_length=1, max_length=500)
    rollback_plan_ref: str = Field(..., min_length=1, max_length=500)
    smoke_runbook_ref: str = Field(..., min_length=1, max_length=500)
    execute_contract_signature: str | None = Field(default=None, max_length=500)
    execute_contract_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationExecuteContractRecordResponse(BaseModel):
    ok: bool
    status: str
    runtime_flag_execute_contract: dict[str, Any]
    evidence: ControlPlaneEvidence
...
class SDKRuntimeFlagApplicationAdapterImplementationRequestRecordRequest(BaseModel):
    adapter_implementation_request_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    readiness_plan_decision_id: str = Field(..., min_length=1, max_length=240)
    readiness_plan_decision_audit_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_execute_contract_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_approval_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_preflight_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_enablement_id: str = Field(..., min_length=1, max_length=240)
    ...
    requested_by: str = Field(..., min_length=1, max_length=240)
    requested_at: str = Field(..., min_length=1, max_length=80)
    implementation_request_reason: str = Field(..., min_length=1, max_length=1000)
    adapter_design_ref: str = Field(..., min_length=1, max_length=500)
    rollback_plan_ref: str = Field(..., min_length=1, max_length=500)
    smoke_runbook_ref: str = Field(..., min_length=1, max_length=500)
    request_signature: str | None = Field(default=None, max_length=500)
    request_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationAdapterImplementationRequestRecordResponse(BaseModel):
    ok: bool
    status: str
    adapter_implementation_request: dict[str, Any]
    evidence: ControlPlaneEvidence


class SDKRuntimeFlagApplicationAdapterDesignReviewRecordRequest(BaseModel):
    adapter_design_review_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_request_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_request_audit_id: str = Field(..., min_length=1, max_length=240)
    readiness_plan_decision_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_execute_contract_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_approval_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_preflight_id: str = Field(..., min_length=1, max_length=240)
    ...
    final_decision_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_name: str = Field(..., min_length=1, max_length=240)
    review_decision: str = Field(..., min_length=1, max_length=20)
    ...
    rollback_plan_ref: str = Field(..., min_length=1, max_length=500)
    smoke_runbook_ref: str = Field(..., min_length=1, max_length=500)
    review_signature: str | None = Field(default=None, max_length=500)
    review_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationAdapterDesignReviewRecordResponse(BaseModel):
    ok: bool
    status: str
    adapter_design_review: dict[str, Any]
    evidence: ControlPlaneEvidence
...
class SDKRuntimeFlagApplicationAdapterCodeChangeRecordRequest(BaseModel):
    adapter_code_change_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_preflight_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_preflight_audit_id: str = Field(..., min_length=1, max_length=240)
    adapter_design_review_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_request_id: str = Field(..., min_length=1, max_length=240)
    readiness_plan_decision_id: str = Field(..., min_length=1, max_length=240)
    runtime_flag_execute_contract_id: str = Field(..., min_length=1, max_length=240)
    ...
    adapter_module: str = Field(..., min_length=1, max_length=500)
    adapter_class: str = Field(..., min_length=1, max_length=240)
    implementation_branch_ref: str = Field(..., min_length=1, max_length=500)
    implementation_plan_ref: str = Field(..., min_length=1, max_length=500)
    adapter_design_ref: str = Field(..., min_length=1, max_length=500)
    security_review_ref: str = Field(..., min_length=1, max_length=500)
    ...
    idempotency_key: str = Field(..., min_length=1, max_length=240)
    idempotency_hash: str = Field(..., min_length=1, max_length=500)
    code_change_signature: str | None = Field(default=None, max_length=500)
    code_change_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationAdapterCodeChangeRecordResponse(BaseModel):
    ok: bool
    status: str
    adapter_code_change: dict[str, Any]
    evidence: ControlPlaneEvidence


class SDKRuntimeFlagApplicationAdapterWiringRecordRequest(BaseModel):
    adapter_wiring_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    adapter_code_change_id: str = Field(..., min_length=1, max_length=240)
    adapter_code_change_audit_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_preflight_id: str = Field(..., min_length=1, max_length=240)
    adapter_design_review_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_request_id: str = Field(..., min_length=1, max_length=240)
    readiness_plan_decision_id: str = Field(..., min_length=1, max_length=240)
    ...
    runtime_flag_name: str = Field(..., min_length=1, max_length=240)
    operator_id: str = Field(..., min_length=1, max_length=240)
    wired_at: str = Field(..., min_length=1, max_length=80)
    adapter_module: str = Field(..., min_length=1, max_length=500)
    adapter_class: str = Field(..., min_length=1, max_length=240)
    wiring_plan_ref: str = Field(..., min_length=1, max_length=500)
    implementation_branch_ref: str = Field(..., min_length=1, max_length=500)
    implementation_plan_ref: str = Field(..., min_length=1, max_length=500)
    adapter_design_ref: str = Field(..., min_length=1, max_length=500)
    security_review_ref: str = Field(..., min_length=1, max_length=500)
    ...
    idempotency_key: str = Field(..., min_length=1, max_length=240)
    idempotency_hash: str = Field(..., min_length=1, max_length=500)
    wiring_signature: str | None = Field(default=None, max_length=500)
    wiring_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationAdapterWiringRecordResponse(BaseModel):
    ok: bool
    status: str
    adapter_wiring: dict[str, Any]
    evidence: ControlPlaneEvidence


class SDKRuntimeFlagApplicationAdapterRuntimePreflightRecordRequest(BaseModel):
    adapter_runtime_preflight_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    adapter_wiring_id: str = Field(..., min_length=1, max_length=240)
    adapter_wiring_audit_id: str = Field(..., min_length=1, max_length=240)
    adapter_code_change_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_preflight_id: str = Field(..., min_length=1, max_length=240)
    adapter_design_review_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_request_id: str = Field(..., min_length=1, max_length=240)
    ...
    runtime_flag_name: str = Field(..., min_length=1, max_length=240)
    operator_id: str = Field(..., min_length=1, max_length=240)
    preflighted_at: str = Field(..., min_length=1, max_length=80)
    adapter_module: str = Field(..., min_length=1, max_length=500)
    adapter_class: str = Field(..., min_length=1, max_length=240)
    runtime_preflight_plan_ref: str = Field(..., min_length=1, max_length=500)
    wiring_plan_ref: str = Field(..., min_length=1, max_length=500)
    implementation_branch_ref: str = Field(..., min_length=1, max_length=500)
    implementation_plan_ref: str = Field(..., min_length=1, max_length=500)
    adapter_design_ref: str = Field(..., min_length=1, max_length=500)
    ...
    idempotency_key: str = Field(..., min_length=1, max_length=240)
    idempotency_hash: str = Field(..., min_length=1, max_length=500)
    runtime_preflight_signature: str | None = Field(default=None, max_length=500)
    runtime_preflight_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationAdapterRuntimePreflightRecordResponse(BaseModel):
    ok: bool
    status: str
    adapter_runtime_preflight: dict[str, Any]
    evidence: ControlPlaneEvidence


class SDKRuntimeFlagApplicationAdapterExecutionDryRunRecordRequest(BaseModel):
    adapter_execution_dry_run_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    adapter_runtime_preflight_id: str = Field(..., min_length=1, max_length=240)
    adapter_runtime_preflight_audit_id: str = Field(..., min_length=1, max_length=240)
    adapter_wiring_id: str = Field(..., min_length=1, max_length=240)
    adapter_code_change_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_preflight_id: str = Field(..., min_length=1, max_length=240)
    adapter_design_review_id: str = Field(..., min_length=1, max_length=240)
    ...
    runtime_flag_name: str = Field(..., min_length=1, max_length=240)
    operator_id: str = Field(..., min_length=1, max_length=240)
    dry_run_started_at: str = Field(..., min_length=1, max_length=80)
    adapter_module: str = Field(..., min_length=1, max_length=500)
    adapter_class: str = Field(..., min_length=1, max_length=240)
    execution_dry_run_plan_ref: str = Field(..., min_length=1, max_length=500)
    runtime_preflight_plan_ref: str = Field(..., min_length=1, max_length=500)
    wiring_plan_ref: str = Field(..., min_length=1, max_length=500)
    implementation_branch_ref: str = Field(..., min_length=1, max_length=500)
    implementation_plan_ref: str = Field(..., min_length=1, max_length=500)
    ...
    idempotency_key: str = Field(..., min_length=1, max_length=240)
    idempotency_hash: str = Field(..., min_length=1, max_length=500)
    execution_dry_run_signature: str | None = Field(default=None, max_length=500)
    execution_dry_run_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationAdapterExecutionDryRunRecordResponse(BaseModel):
    ok: bool
    status: str
    adapter_execution_dry_run: dict[str, Any]
    evidence: ControlPlaneEvidence


class SDKRuntimeFlagApplicationAdapterExecutionGateRecordRequest(BaseModel):
    adapter_execution_gate_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    adapter_execution_dry_run_id: str = Field(..., min_length=1, max_length=240)
    adapter_execution_dry_run_audit_id: str = Field(..., min_length=1, max_length=240)
    adapter_runtime_preflight_id: str = Field(..., min_length=1, max_length=240)
    adapter_wiring_id: str = Field(..., min_length=1, max_length=240)
    adapter_code_change_id: str = Field(..., min_length=1, max_length=240)
    adapter_implementation_preflight_id: str = Field(..., min_length=1, max_length=240)
    ...
    runtime_flag_name: str = Field(..., min_length=1, max_length=240)
    operator_id: str = Field(..., min_length=1, max_length=240)
    gated_at: str = Field(..., min_length=1, max_length=80)
    adapter_module: str = Field(..., min_length=1, max_length=500)
    adapter_class: str = Field(..., min_length=1, max_length=240)
    execution_gate_plan_ref: str = Field(..., min_length=1, max_length=500)
    execution_dry_run_plan_ref: str = Field(..., min_length=1, max_length=500)
    runtime_preflight_plan_ref: str = Field(..., min_length=1, max_length=500)
    wiring_plan_ref: str = Field(..., min_length=1, max_length=500)
    implementation_branch_ref: str = Field(..., min_length=1, max_length=500)
    ...
    idempotency_key: str = Field(..., min_length=1, max_length=240)
    idempotency_hash: str = Field(..., min_length=1, max_length=500)
    execution_gate_signature: str | None = Field(default=None, max_length=500)
    execution_gate_hash: str | None = Field(default=None, max_length=500)
    notes: str | None = Field(default=None, max_length=2000)
    dry_run: bool = True


class SDKRuntimeFlagApplicationAdapterExecutionGateRecordResponse(BaseModel):
    ok: bool
    status: str
    adapter_execution_gate: dict[str, Any]
    evidence: ControlPlaneEvidence


class SDKLiveWriteRunnerExecutionAcceptanceRecordRequest(BaseModel):
    execution_acceptance_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    adapter_execution_gate_id: str = Field(..., min_length=1, max_length=240)
    adapter_execution_gate_audit_id: str = Field(..., min_length=1, max_length=240)
    adapter_execution_dry_run_id: str = Field(..., min_length=1, max_length=240)
    adapter_runtime_preflight_id: str = Field(..., min_length=1, max_length=240)
    adapter_wiring_id: str = Field(..., min_length=1, max_length=240)
    adapter_code_change_id: str = Field(..., min_length=1, max_length=240)
    ...
    adapter_module: str = Field(..., min_length=1, max_length=500)
    adapter_class: str = Field(..., min_length=1, max_length=240)
    execution_acceptance_plan_ref: str = Field(..., min_length=1, max_length=500)
    execution_gate_plan_ref: str = Field(..., min_length=1, max_length=500)
    execution_dry_run_plan_ref: str = Field(..., min_length=1, max_length=500)
    runtime_preflight_plan_ref: str = Field(..., min_length=1, max_length=500)
    wiring_plan_ref: str = Field(..., min_length=1, max_length=500)
...
class SDKLiveWriteRunnerExecutionAcceptanceRecordResponse(BaseModel):
    ok: bool
    status: str
...
class SDKLiveWriteRunnerInvocationReviewRecordRequest(BaseModel):
    invocation_review_id: str = Field(..., min_length=1, max_length=240)
    approval_id: str = Field(..., min_length=1, max_length=240)
    execution_acceptance_id: str = Field(..., min_length=1, max_length=240)
    execution_acceptance_audit_id: str = Field(..., min_length=1, max_length=240)
    adapter_execution_gate_id: str = Field(..., min_length=1, max_length=240)
    adapter_execution_gate_audit_id: str = Field(..., min_length=1, max_length=240)
    adapter_execution_dry_run_id: str = Field(..., min_length=1, max_length=240)
    adapter_runtime_preflight_id: str = Field(..., min_length=1, max_length=240)
    ...
    adapter_module: str = Field(..., min_length=1, max_length=500)
    adapter_class: str = Field(..., min_length=1, max_length=240)
    invocation_review_plan_ref: str = Field(..., min_length=1, max_length=500)
    execution_acceptance_plan_ref: str = Field(..., min_length=1, max_length=500)
    execution_gate_plan_ref: str = Field(..., min_length=1, max_length=500)
    execution_dry_run_plan_ref: str = Field(..., min_length=1, max_length=500)
    runtime_preflight_plan_ref: str = Field(..., min_length=1, max_length=500)
...
class SDKLiveWriteRunnerInvocationReviewRecordResponse(BaseModel):
    ok: bool
    status: str
    invocation_review: dict[str, Any]
    evidence: ControlPlaneEvidence
...
async def invoke_sdk_control_plane(
    ...
    sdk_metadata["runtime_flag_application_preflight_workflow"] = (
        _sdk_runtime_flag_application_preflight_workflow_contract(
            sdk_metadata["runtime_flag_enablement_record_workflow"],
        )
    )
    sdk_metadata["runtime_flag_application_owner_approval_workflow"] = (
        _sdk_runtime_flag_application_owner_approval_workflow_contract(
            sdk_metadata["runtime_flag_application_preflight_workflow"],
        )
    )
    sdk_metadata["runtime_flag_application_execute_contract_workflow"] = (
        _sdk_runtime_flag_application_execute_contract_workflow_contract(
            sdk_metadata["runtime_flag_application_owner_approval_workflow"],
        )
    )
    ...
    sdk_metadata["live_runtime_flag_application_implementation_readiness_plan"] = (
        _sdk_live_runtime_flag_application_implementation_readiness_plan_contract(
            sdk_metadata["runtime_flag_application_execute_contract_owner_review"],
        )
    )
    ...
    sdk_metadata["live_runtime_flag_application_adapter_implementation_request_workflow"] = (
        _sdk_live_runtime_flag_application_adapter_implementation_request_workflow_contract(
            sdk_metadata["live_runtime_flag_application_readiness_plan_decision_workflow"],
        )
    )
    ...
    sdk_metadata["live_runtime_flag_application_adapter_code_change_workflow"] = (
        _sdk_live_runtime_flag_application_adapter_code_change_workflow_contract(
            sdk_metadata["live_runtime_flag_application_adapter_implementation_preflight_workflow"],
        )
    )
    sdk_metadata["live_runtime_flag_application_adapter_wiring_workflow"] = (
        _sdk_live_runtime_flag_application_adapter_wiring_workflow_contract(
            sdk_metadata["live_runtime_flag_application_adapter_code_change_workflow"],
        )
    )
    sdk_metadata["live_runtime_flag_application_adapter_runtime_preflight_workflow"] = (
        _sdk_live_runtime_flag_application_adapter_runtime_preflight_workflow_contract(
            sdk_metadata["live_runtime_flag_application_adapter_wiring_workflow"],
        )
    )
    sdk_metadata["live_runtime_flag_application_adapter_execution_dry_run_workflow"] = (
        _sdk_live_runtime_flag_application_adapter_execution_dry_run_workflow_contract(
            sdk_metadata["live_runtime_flag_application_adapter_runtime_preflight_workflow"],
        )
    )
    sdk_metadata["live_runtime_flag_application_adapter_execution_gate_workflow"] = (
        _sdk_live_runtime_flag_application_adapter_execution_gate_workflow_contract(
            sdk_metadata["live_runtime_flag_application_adapter_execution_dry_run_workflow"],
        )
    )
    sdk_metadata["live_write_runner_execution_acceptance_workflow"] = (
        _sdk_live_write_runner_execution_acceptance_workflow_contract(
            sdk_metadata["live_runtime_flag_application_adapter_execution_gate_workflow"],
        )
    )
    sdk_metadata["live_write_runner_invocation_review_workflow"] = (
        _sdk_live_write_runner_invocation_review_workflow_contract(
            sdk_metadata["live_write_runner_execution_acceptance_workflow"],
        )
    )
...
@router.post(
    "/sdk/runtime-flag/application-preflight/record",
    response_model=SDKRuntimeFlagApplicationPreflightRecordResponse,
)
async def record_sdk_runtime_flag_application_preflight(
    request: SDKRuntimeFlagApplicationPreflightRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationPreflightRecordResponse:
    """Record runtime flag application preflight evidence without applying the flag."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    runtime_flag_preflight = _sdk_record_runtime_flag_application_preflight(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=runtime_flag_preflight.get("audit_id")
        if runtime_flag_preflight.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationPreflightRecordResponse(
        ok=runtime_flag_preflight["record_status"] == "recorded",
        status="sdk_runtime_flag_application_preflight_workflow_ready",
        runtime_flag_preflight=runtime_flag_preflight,
        evidence=evidence,
    )


@router.post(
    "/sdk/runtime-flag/application-approval/record",
    response_model=SDKRuntimeFlagApplicationOwnerApprovalRecordResponse,
)
async def record_sdk_runtime_flag_application_owner_approval(
    request: SDKRuntimeFlagApplicationOwnerApprovalRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationOwnerApprovalRecordResponse:
    """Record owner approval intent for runtime flag application without applying it."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    runtime_flag_approval = _sdk_record_runtime_flag_application_owner_approval(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=runtime_flag_approval.get("audit_id")
        if runtime_flag_approval.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationOwnerApprovalRecordResponse(
        ok=runtime_flag_approval["record_status"] == "recorded",
        status="sdk_runtime_flag_application_owner_approval_workflow_ready",
        runtime_flag_approval=runtime_flag_approval,
        evidence=evidence,
    )


@router.post(
    "/sdk/runtime-flag/application-execute-contract/record",
    response_model=SDKRuntimeFlagApplicationExecuteContractRecordResponse,
)
async def record_sdk_runtime_flag_application_execute_contract(
    request: SDKRuntimeFlagApplicationExecuteContractRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationExecuteContractRecordResponse:
    """Record the live runtime flag application execute contract without applying it."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    execute_contract = _sdk_record_runtime_flag_application_execute_contract(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=execute_contract.get("audit_id")
        if execute_contract.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationExecuteContractRecordResponse(
...
@router.post(
    "/sdk/runtime-flag/application-adapter/implementation-request/record",
    response_model=SDKRuntimeFlagApplicationAdapterImplementationRequestRecordResponse,
)
async def record_sdk_runtime_flag_application_adapter_implementation_request(
    request: SDKRuntimeFlagApplicationAdapterImplementationRequestRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationAdapterImplementationRequestRecordResponse:
    """Record the explicit owner request to implement the live runtime flag adapter."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    adapter_implementation_request = (
        _sdk_record_runtime_flag_application_adapter_implementation_request(
            request,
            principal=principal,
            approval_store=approval_store,
            audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=adapter_implementation_request.get("audit_id")
        if adapter_implementation_request.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationAdapterImplementationRequestRecordResponse(
        ok=adapter_implementation_request["record_status"] == "recorded",
        status="sdk_live_runtime_flag_application_adapter_implementation_request_workflow_ready",
        adapter_implementation_request=adapter_implementation_request,
        evidence=evidence,
    )


@router.post(
    "/sdk/runtime-flag/application-adapter/design-review/record",
    response_model=SDKRuntimeFlagApplicationAdapterDesignReviewRecordResponse,
)
async def record_sdk_runtime_flag_application_adapter_design_review(
    request: SDKRuntimeFlagApplicationAdapterDesignReviewRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationAdapterDesignReviewRecordResponse:
    """Record owner design review for the live runtime flag adapter without enabling it."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    adapter_design_review = _sdk_record_runtime_flag_application_adapter_design_review(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=adapter_design_review.get("audit_id")
        if adapter_design_review.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationAdapterDesignReviewRecordResponse(
...
@router.post(
    "/sdk/runtime-flag/application-adapter/code-change/record",
    response_model=SDKRuntimeFlagApplicationAdapterCodeChangeRecordResponse,
)
async def record_sdk_runtime_flag_application_adapter_code_change(
    request: SDKRuntimeFlagApplicationAdapterCodeChangeRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationAdapterCodeChangeRecordResponse:
    """Record the disabled adapter code-change gate without enabling runtime execution."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    adapter_code_change = _sdk_record_runtime_flag_application_adapter_code_change(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=adapter_code_change.get("audit_id")
        if adapter_code_change.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationAdapterCodeChangeRecordResponse(
        ok=adapter_code_change["record_status"] == "recorded",
        status="sdk_live_runtime_flag_application_adapter_code_change_workflow_ready",
        adapter_code_change=adapter_code_change,
        evidence=evidence,
    )


@router.post(
    "/sdk/runtime-flag/application-adapter/wiring/record",
    response_model=SDKRuntimeFlagApplicationAdapterWiringRecordResponse,
)
async def record_sdk_runtime_flag_application_adapter_wiring(
    request: SDKRuntimeFlagApplicationAdapterWiringRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationAdapterWiringRecordResponse:
    """Record the disabled adapter wiring gate without wiring runtime execution."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    adapter_wiring = _sdk_record_runtime_flag_application_adapter_wiring(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=adapter_wiring.get("audit_id")
        if adapter_wiring.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationAdapterWiringRecordResponse(
        ok=adapter_wiring["record_status"] == "recorded",
        status="sdk_live_runtime_flag_application_adapter_wiring_workflow_ready",
        adapter_wiring=adapter_wiring,
        evidence=evidence,
    )


@router.post(
    "/sdk/runtime-flag/application-adapter/runtime-preflight/record",
    response_model=SDKRuntimeFlagApplicationAdapterRuntimePreflightRecordResponse,
)
async def record_sdk_runtime_flag_application_adapter_runtime_preflight(
    request: SDKRuntimeFlagApplicationAdapterRuntimePreflightRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationAdapterRuntimePreflightRecordResponse:
    """Record the disabled adapter runtime preflight without enabling runtime execution."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    adapter_runtime_preflight = _sdk_record_runtime_flag_application_adapter_runtime_preflight(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=adapter_runtime_preflight.get("audit_id")
        if adapter_runtime_preflight.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationAdapterRuntimePreflightRecordResponse(
        ok=adapter_runtime_preflight["record_status"] == "recorded",
        status="sdk_live_runtime_flag_application_adapter_runtime_preflight_workflow_ready",
        adapter_runtime_preflight=adapter_runtime_preflight,
        evidence=evidence,
    )


@router.post(
    "/sdk/runtime-flag/application-adapter/execution-dry-run/record",
    response_model=SDKRuntimeFlagApplicationAdapterExecutionDryRunRecordResponse,
)
async def record_sdk_runtime_flag_application_adapter_execution_dry_run(
    request: SDKRuntimeFlagApplicationAdapterExecutionDryRunRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationAdapterExecutionDryRunRecordResponse:
    """Record disabled adapter execution dry-run intent without invoking execution."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    adapter_execution_dry_run = _sdk_record_runtime_flag_application_adapter_execution_dry_run(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=adapter_execution_dry_run.get("audit_id")
        if adapter_execution_dry_run.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationAdapterExecutionDryRunRecordResponse(
        ok=adapter_execution_dry_run["record_status"] == "recorded",
        status="sdk_live_runtime_flag_application_adapter_execution_dry_run_workflow_ready",
        adapter_execution_dry_run=adapter_execution_dry_run,
        evidence=evidence,
    )


@router.post(
    "/sdk/runtime-flag/application-adapter/execution-gate/record",
    response_model=SDKRuntimeFlagApplicationAdapterExecutionGateRecordResponse,
)
async def record_sdk_runtime_flag_application_adapter_execution_gate(
    request: SDKRuntimeFlagApplicationAdapterExecutionGateRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKRuntimeFlagApplicationAdapterExecutionGateRecordResponse:
    """Record the final disabled adapter execution gate without opening execution."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    adapter_execution_gate = _sdk_record_runtime_flag_application_adapter_execution_gate(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=adapter_execution_gate.get("audit_id")
        if adapter_execution_gate.get("audit_event_recorded")
        else None,
    )
    return SDKRuntimeFlagApplicationAdapterExecutionGateRecordResponse(
        ok=adapter_execution_gate["record_status"] == "recorded",
        status="sdk_live_runtime_flag_application_adapter_execution_gate_workflow_ready",
        adapter_execution_gate=adapter_execution_gate,
        evidence=evidence,
    )


@router.post(
    "/sdk/live-write-runner/execution-acceptance/record",
    response_model=SDKLiveWriteRunnerExecutionAcceptanceRecordResponse,
)
async def record_sdk_live_write_runner_execution_acceptance(
    request: SDKLiveWriteRunnerExecutionAcceptanceRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKLiveWriteRunnerExecutionAcceptanceRecordResponse:
    """Record owner acceptance for future live SDK write-runner execution only."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    execution_acceptance = _sdk_record_live_write_runner_execution_acceptance(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=execution_acceptance.get("audit_id")
        if execution_acceptance.get("audit_event_recorded")
        else None,
    )
    return SDKLiveWriteRunnerExecutionAcceptanceRecordResponse(
        ok=execution_acceptance["record_status"] == "recorded",
...
@router.post(
    "/sdk/live-write-runner/invocation-review/record",
    response_model=SDKLiveWriteRunnerInvocationReviewRecordResponse,
)
async def record_sdk_live_write_runner_invocation_review(
    request: SDKLiveWriteRunnerInvocationReviewRecordRequest,
    principal: PrincipalDependency,
    audit_store: AuditStoreDependency,
    approval_store: ApprovalStoreDependency,
) -> SDKLiveWriteRunnerInvocationReviewRecordResponse:
    """Record owner review evidence before any live SDK write-runner invocation."""
    enforce_scope(principal, "workflow:control")
    trace_id = principal.trace_id or f"trace_{uuid4().hex}"
    invocation_review = _sdk_record_live_write_runner_invocation_review(
        request,
        principal=principal,
        approval_store=approval_store,
        audit_store=audit_store,
    ...
    evidence = ControlPlaneEvidence(
        trace_id=trace_id,
        audit_id=invocation_review.get("audit_id")
        if invocation_review.get("audit_event_recorded")
        else None,
    )
    return SDKLiveWriteRunnerInvocationReviewRecordResponse(
        ok=invocation_review["record_status"] == "recorded",
        status="sdk_live_write_runner_invocation_review_workflow_ready",
        invocation_review=invocation_review,
        evidence=evidence,
    )
...
def _sdk_runtime_flag_application_preflight_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        ...
        "approval_id",
        "runtime_flag_enablement_id",
        "runtime_flag_enablement_audit_id",
        "final_decision_id",
        "runtime_flag_name",
        "target_state",
        "requested_by",
    ...
    checks = {
        ...
        "target_state_allowed": bool(
            isinstance(record, dict) and record.get("target_state") in {"enabled", "disabled"}
        ),
        "signature_or_hash_present": bool(
...
def _sdk_record_runtime_flag_application_preflight(
    request: SDKRuntimeFlagApplicationPreflightRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    runtime_flag_enablement = _sdk_runtime_flag_enablement_record_from_audit(
        audit_store,
        runtime_flag_enablement_id=request.runtime_flag_enablement_id,
        approval_id=request.approval_id,
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.runtime_flag_enablement_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_preflight = {
        ...
        "approval_id": request.approval_id,
        "runtime_flag_enablement_id": request.runtime_flag_enablement_id,
        "runtime_flag_enablement_audit_id": request.runtime_flag_enablement_audit_id,
        "final_decision_id": request.final_decision_id,
        "runtime_flag_name": request.runtime_flag_name,
    ...
    validation = _sdk_runtime_flag_application_preflight_validation(raw_preflight)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "runtime_flag_enablement_audit_record_present": isinstance(runtime_flag_enablement, dict),
        "runtime_flag_enablement_validation_valid": bool(
            isinstance(runtime_flag_enablement, dict)
            and _sdk_runtime_flag_enablement_validation(runtime_flag_enablement)["status"] == "valid"
        ),
        "runtime_flag_preflight_valid": validation["status"] == "valid",
    ...
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.runtime_flag_preflight_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.requested_by,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "runtime_flag_preflight": preflight_payload,
                "runtime_flag_enablement_record": runtime_flag_enablement,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
    ...
    return {
        ...
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-preflight/record",
        "runtime_flag_preflight_id": request.runtime_flag_preflight_id,
        "approval_id": request.approval_id,
        "runtime_flag_enablement_id": request.runtime_flag_enablement_id,
        "runtime_flag_enablement_audit_id": request.runtime_flag_enablement_audit_id,
        ...
        "channel_mutation_performed": False,
        "known_limits": [
            "This endpoint records runtime flag application preflight evidence only.",
            "It does not apply XAGENT_SDK_WRITE_RUNNER_ENABLED or invoke the SDK write runner.",
            "Live runtime flag application remains a separate owner-requested implementation task.",
        ],
    }


def _sdk_runtime_flag_application_owner_approval_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        ...
        "approval_id",
        "runtime_flag_preflight_id",
        "runtime_flag_preflight_audit_id",
        "runtime_flag_enablement_id",
        "final_decision_id",
        "runtime_flag_name",
        "decision",
    ...
    checks = {
        ...
        "signature_or_hash_present": bool(
            isinstance(record, dict) and (record.get("approval_signature") or record.get("approval_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_record_runtime_flag_application_owner_approval(
    request: SDKRuntimeFlagApplicationOwnerApprovalRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    runtime_flag_preflight = _sdk_runtime_flag_application_preflight_record_from_audit(
        audit_store,
        runtime_flag_preflight_id=request.runtime_flag_preflight_id,
        approval_id=request.approval_id,
        runtime_flag_enablement_id=request.runtime_flag_enablement_id,
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.runtime_flag_preflight_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_approval = {
        ...
        "approval_id": request.approval_id,
        "runtime_flag_preflight_id": request.runtime_flag_preflight_id,
        "runtime_flag_preflight_audit_id": request.runtime_flag_preflight_audit_id,
        "runtime_flag_enablement_id": request.runtime_flag_enablement_id,
        "final_decision_id": request.final_decision_id,
        "runtime_flag_name": request.runtime_flag_name,
        "decision": request.decision,
    ...
    validation = _sdk_runtime_flag_application_owner_approval_validation(raw_approval)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "runtime_flag_preflight_audit_record_present": isinstance(runtime_flag_preflight, dict),
        "runtime_flag_preflight_validation_valid": bool(
            isinstance(runtime_flag_preflight, dict)
            and _sdk_runtime_flag_application_preflight_validation(runtime_flag_preflight)["status"] == "valid"
        ),
        "runtime_flag_owner_approval_valid": validation["status"] == "valid",
        "dry_run_does_not_apply_flag": request.dry_run is True,
    }
    can_record = all(checks.values())
    approval_payload = {
        key: value
        for key, value in raw_approval.items()
        if value is not None
    }
    audit_record = None
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.runtime_flag_approval_id,
            outcome=request.decision,
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.decided_by,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "runtime_flag_owner_approval": approval_payload,
                "runtime_flag_preflight_record": runtime_flag_preflight,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        ...
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-approval/record",
        "runtime_flag_approval_id": request.runtime_flag_approval_id,
        "approval_id": request.approval_id,
        "runtime_flag_preflight_id": request.runtime_flag_preflight_id,
        "runtime_flag_preflight_audit_id": request.runtime_flag_preflight_audit_id,
        ...
        "channel_mutation_performed": False,
        "known_limits": [
            "This endpoint records owner approval intent for runtime flag application only.",
            "It does not set XAGENT_SDK_WRITE_RUNNER_ENABLED or invoke the SDK write runner.",
            "Live runtime flag application remains a separate owner-reviewed execution contract.",
        ],
    }


def _sdk_runtime_flag_application_execute_contract_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        ...
        "approval_id",
        "runtime_flag_approval_id",
        "runtime_flag_approval_audit_id",
        "runtime_flag_preflight_id",
        "runtime_flag_enablement_id",
        "final_decision_id",
        "runtime_flag_name",
    ...
    checks = {
        ...
        "idempotency_key_present": bool(isinstance(record, dict) and record.get("idempotency_key")),
        "idempotency_hash_present": bool(isinstance(record, dict) and record.get("idempotency_hash")),
        ...
        "signature_or_hash_present": bool(
            isinstance(record, dict)
            and (record.get("execute_contract_signature") or record.get("execute_contract_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_record_runtime_flag_application_execute_contract(
    request: SDKRuntimeFlagApplicationExecuteContractRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    runtime_flag_approval = _sdk_runtime_flag_application_owner_approval_record_from_audit(
        audit_store,
        runtime_flag_approval_id=request.runtime_flag_approval_id,
        approval_id=request.approval_id,
        runtime_flag_preflight_id=request.runtime_flag_preflight_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.runtime_flag_approval_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_execute_contract = {
        ...
        "approval_id": request.approval_id,
        "runtime_flag_approval_id": request.runtime_flag_approval_id,
        "runtime_flag_approval_audit_id": request.runtime_flag_approval_audit_id,
        "runtime_flag_preflight_id": request.runtime_flag_preflight_id,
        "runtime_flag_enablement_id": request.runtime_flag_enablement_id,
        "final_decision_id": request.final_decision_id,
        "runtime_flag_name": request.runtime_flag_name,
        "operator_id": request.operator_id,
        "locked_at": request.locked_at,
        "execute_contract_reason": request.execute_contract_reason,
        "idempotency_key": request.idempotency_key,
        "idempotency_hash": request.idempotency_hash,
        "rollback_plan_ref": request.rollback_plan_ref,
        "smoke_runbook_ref": request.smoke_runbook_ref,
        "execute_contract_signature": request.execute_contract_signature,
        "execute_contract_hash": request.execute_contract_hash,
        "notes": request.notes,
    }
    validation = _sdk_runtime_flag_application_execute_contract_validation(raw_execute_contract)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "runtime_flag_owner_approval_audit_record_present": isinstance(runtime_flag_approval, dict),
        "runtime_flag_owner_approval_validation_valid": bool(
            isinstance(runtime_flag_approval, dict)
            and _sdk_runtime_flag_application_owner_approval_validation(runtime_flag_approval)["status"] == "valid"
        ),
        "runtime_flag_owner_approval_accepted": bool(
            isinstance(runtime_flag_approval, dict) and runtime_flag_approval.get("decision") == "accepted"
        ),
        "runtime_flag_execute_contract_valid": validation["status"] == "valid",
        "dry_run_does_not_apply_flag": request.dry_run is True,
    }
    can_record = all(checks.values())
    execute_contract_payload = {
        key: value
        for key, value in raw_execute_contract.items()
        if value is not None
    }
    audit_record = None
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.runtime_flag_execute_contract_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.operator_id,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "runtime_flag_execute_contract": execute_contract_payload,
                "runtime_flag_owner_approval_record": runtime_flag_approval,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        ...
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-execute-contract/record",
        "runtime_flag_execute_contract_id": request.runtime_flag_execute_contract_id,
        "approval_id": request.approval_id,
        "runtime_flag_approval_id": request.runtime_flag_approval_id,
        "runtime_flag_approval_audit_id": request.runtime_flag_approval_audit_id,
        ...
        "channel_mutation_performed": False,
        "known_limits": [
            "This endpoint records the live runtime flag application execute contract only.",
            "It does not set XAGENT_SDK_WRITE_RUNNER_ENABLED or invoke the SDK write runner.",
            "Live runtime flag application implementation remains a separate owner-requested task.",
        ],
    }
...
def _sdk_runtime_flag_application_adapter_implementation_request_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        ...
        "approval_id",
        "readiness_plan_decision_id",
        "readiness_plan_decision_audit_id",
        "runtime_flag_execute_contract_id",
        "runtime_flag_approval_id",
        "runtime_flag_preflight_id",
        "runtime_flag_enablement_id",
    ...
    checks = {
        ...
        "smoke_runbook_ref_present": bool(isinstance(record, dict) and record.get("smoke_runbook_ref")),
        "signature_or_hash_present": bool(
            isinstance(record, dict) and (record.get("request_signature") or record.get("request_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_record_runtime_flag_application_adapter_implementation_request(
    request: SDKRuntimeFlagApplicationAdapterImplementationRequestRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    readiness_plan_decision = _sdk_runtime_flag_application_readiness_plan_decision_record_from_audit(
        audit_store,
        readiness_plan_decision_id=request.readiness_plan_decision_id,
        approval_id=request.approval_id,
        runtime_flag_execute_contract_id=request.runtime_flag_execute_contract_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.readiness_plan_decision_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_request = {
        ...
        "approval_id": request.approval_id,
        "readiness_plan_decision_id": request.readiness_plan_decision_id,
        "readiness_plan_decision_audit_id": request.readiness_plan_decision_audit_id,
        "runtime_flag_execute_contract_id": request.runtime_flag_execute_contract_id,
        "runtime_flag_approval_id": request.runtime_flag_approval_id,
        "runtime_flag_preflight_id": request.runtime_flag_preflight_id,
        "runtime_flag_enablement_id": request.runtime_flag_enablement_id,
        ...
        "requested_by": request.requested_by,
        "requested_at": request.requested_at,
        "implementation_request_reason": request.implementation_request_reason,
    ...
    validation = _sdk_runtime_flag_application_adapter_implementation_request_validation(raw_request)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "readiness_plan_decision_audit_record_present": isinstance(readiness_plan_decision, dict),
        "readiness_plan_decision_validation_valid": bool(
            isinstance(readiness_plan_decision, dict)
            and _sdk_runtime_flag_application_readiness_plan_decision_validation(readiness_plan_decision)["status"]
            == "valid"
        ),
        "readiness_plan_decision_outcome_accepted": bool(
            isinstance(readiness_plan_decision, dict)
            and readiness_plan_decision.get("record_outcome") == "accepted"
            and readiness_plan_decision.get("decision") == "accepted"
        ),
        "adapter_implementation_request_valid": validation["status"] == "valid",
    ...
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.adapter_implementation_request_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.requested_by,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "adapter_implementation_request": request_payload,
                "readiness_plan_decision_record": readiness_plan_decision,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        "stage": "runtime_flag_application_adapter_implementation_request_workflow",
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/implementation-request/record",
        "adapter_implementation_request_id": request.adapter_implementation_request_id,
        "approval_id": request.approval_id,
        "readiness_plan_decision_id": request.readiness_plan_decision_id,
        "readiness_plan_decision_audit_id": request.readiness_plan_decision_audit_id,
        ...
        "validation": validation,
        "audit_event_recorded": audit_record is not None,
        "audit_action": "sdk.write_runner.runtime_flag_application_adapter_implementation_request_recorded",
        "audit_id": getattr(audit_record, "id", None) if audit_record else None,
        "audit_hash": getattr(audit_record, "hash", None) if audit_record else None,
        "audit_signature_present": bool(getattr(audit_record, "signature", None)) if audit_record else False,
        "runtime_flag_enabled": False,
        ...
        "adapter_execution_allowed": False,
        "known_limits": [
            "This endpoint records the explicit owner request to implement the live runtime flag adapter only.",
            "It does not read, write, or apply XAGENT_SDK_WRITE_RUNNER_ENABLED.",
            "It does not import, instantiate, enable, or execute the live adapter or SDK write runner.",
        ],
    }


def _sdk_runtime_flag_application_adapter_design_review_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        ...
        "approval_id",
        "adapter_implementation_request_id",
        "adapter_implementation_request_audit_id",
        "readiness_plan_decision_id",
        "runtime_flag_execute_contract_id",
        "runtime_flag_approval_id",
        "runtime_flag_preflight_id",
    ...
    checks = {
        ...
        "reviewed_at_rfc3339": bool(
            isinstance(record, dict) and _is_rfc3339_timestamp(record.get("reviewed_at"))
        ),
        "runtime_flag_name_allowed": bool(
            isinstance(record, dict)
            and record.get("runtime_flag_name") == "XAGENT_SDK_WRITE_RUNNER_ENABLED"
        ),
        "review_decision_allowed": bool(
            isinstance(record, dict) and record.get("review_decision") in {"accepted", "rejected"}
        ),
        "adapter_design_ref_present": bool(isinstance(record, dict) and record.get("adapter_design_ref")),
        ...
        "smoke_runbook_ref_present": bool(isinstance(record, dict) and record.get("smoke_runbook_ref")),
        "signature_or_hash_present": bool(
            isinstance(record, dict) and (record.get("review_signature") or record.get("review_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_record_runtime_flag_application_adapter_design_review(
    request: SDKRuntimeFlagApplicationAdapterDesignReviewRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    implementation_request = _sdk_runtime_flag_application_adapter_implementation_request_record_from_audit(
        audit_store,
        adapter_implementation_request_id=request.adapter_implementation_request_id,
        approval_id=request.approval_id,
        readiness_plan_decision_id=request.readiness_plan_decision_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.adapter_implementation_request_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_review = {
        ...
        "approval_id": request.approval_id,
        "adapter_implementation_request_id": request.adapter_implementation_request_id,
        "adapter_implementation_request_audit_id": request.adapter_implementation_request_audit_id,
        "readiness_plan_decision_id": request.readiness_plan_decision_id,
        "runtime_flag_execute_contract_id": request.runtime_flag_execute_contract_id,
        "runtime_flag_approval_id": request.runtime_flag_approval_id,
        "runtime_flag_preflight_id": request.runtime_flag_preflight_id,
        ...
        "rollback_plan_ref": request.rollback_plan_ref,
        "smoke_runbook_ref": request.smoke_runbook_ref,
        "review_signature": request.review_signature,
        "review_hash": request.review_hash,
        "notes": request.notes,
    }
    validation = _sdk_runtime_flag_application_adapter_design_review_validation(raw_review)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "adapter_implementation_request_audit_record_present": isinstance(implementation_request, dict),
        "adapter_implementation_request_validation_valid": bool(
            isinstance(implementation_request, dict)
            and _sdk_runtime_flag_application_adapter_implementation_request_validation(implementation_request)["status"]
            == "valid"
        ),
        "adapter_implementation_request_outcome_accepted": bool(
            isinstance(implementation_request, dict)
            and implementation_request.get("record_outcome") == "accepted"
        ),
        "adapter_design_review_valid": validation["status"] == "valid",
        "dry_run_does_not_enable_adapter": request.dry_run is True,
    }
    can_record = all(checks.values())
    review_payload = {
    ...
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.adapter_design_review_id,
            outcome=request.review_decision,
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.reviewed_by,
            trace_id=trace_id,
            details={
                "approval_id": request.approval_id,
                "adapter_implementation_request_id": request.adapter_implementation_request_id,
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "adapter_design_review": review_payload,
                "adapter_implementation_request_record": implementation_request,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        ...
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/design-review/record",
        "adapter_design_review_id": request.adapter_design_review_id,
        "approval_id": request.approval_id,
        "adapter_implementation_request_id": request.adapter_implementation_request_id,
        "adapter_implementation_request_audit_id": request.adapter_implementation_request_audit_id,
        ...
        "adapter_execution_allowed": False,
        "known_limits": [
            "This endpoint records owner design review for the future live runtime flag adapter only.",
...
def _sdk_runtime_flag_application_adapter_code_change_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        "adapter_code_change_id",
        "approval_id",
        "adapter_implementation_preflight_id",
        "adapter_implementation_preflight_audit_id",
        "adapter_design_review_id",
        "adapter_implementation_request_id",
        "readiness_plan_decision_id",
        "runtime_flag_execute_contract_id",
    ...
    checks = {
        ...
        "changed_at_rfc3339": bool(
            isinstance(record, dict) and _is_rfc3339_timestamp(record.get("changed_at"))
        ),
        "runtime_flag_name_allowed": bool(
            isinstance(record, dict)
            and record.get("runtime_flag_name") == "XAGENT_SDK_WRITE_RUNNER_ENABLED"
        ),
        "adapter_module_allowed": bool(
            isinstance(record, dict)
            and record.get("adapter_module") == "backend.app.sdk.runtime_flag_application_adapter"
        ),
        "adapter_class_allowed": bool(
            isinstance(record, dict)
            and record.get("adapter_class") == "SDKRuntimeFlagApplicationAdapter"
        ),
        "implementation_branch_ref_present": bool(
            isinstance(record, dict) and record.get("implementation_branch_ref")
        ),
        ...
        "signature_or_hash_present": bool(
            isinstance(record, dict) and (record.get("code_change_signature") or record.get("code_change_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_record_runtime_flag_application_adapter_code_change(
    request: SDKRuntimeFlagApplicationAdapterCodeChangeRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    implementation_preflight = (
        _sdk_runtime_flag_application_adapter_implementation_preflight_record_from_audit(
            audit_store,
            adapter_implementation_preflight_id=request.adapter_implementation_preflight_id,
            approval_id=request.approval_id,
            adapter_design_review_id=request.adapter_design_review_id,
            ...
            final_decision_id=request.final_decision_id,
            runtime_flag_name=request.runtime_flag_name,
            audit_id=request.adapter_implementation_preflight_audit_id,
            tenant_id=principal.tenant_id if principal else None,
        )
    )
    raw_code_change = {
        "adapter_code_change_id": request.adapter_code_change_id,
        "approval_id": request.approval_id,
        "adapter_implementation_preflight_id": request.adapter_implementation_preflight_id,
        "adapter_implementation_preflight_audit_id": request.adapter_implementation_preflight_audit_id,
        "adapter_design_review_id": request.adapter_design_review_id,
        "adapter_implementation_request_id": request.adapter_implementation_request_id,
        "readiness_plan_decision_id": request.readiness_plan_decision_id,
        "runtime_flag_execute_contract_id": request.runtime_flag_execute_contract_id,
        ...
        "adapter_module": request.adapter_module,
        ...
        "idempotency_key": request.idempotency_key,
        "idempotency_hash": request.idempotency_hash,
        "code_change_signature": request.code_change_signature,
        "code_change_hash": request.code_change_hash,
        "notes": request.notes,
    }
    validation = _sdk_runtime_flag_application_adapter_code_change_validation(raw_code_change)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "adapter_implementation_preflight_audit_record_present": isinstance(implementation_preflight, dict),
        "adapter_implementation_preflight_validation_valid": bool(
            isinstance(implementation_preflight, dict)
            and _sdk_runtime_flag_application_adapter_implementation_preflight_validation(implementation_preflight)["status"]
            == "valid"
        ),
        "adapter_implementation_preflight_outcome_accepted": bool(
            isinstance(implementation_preflight, dict)
            and implementation_preflight.get("record_outcome") == "accepted"
        ),
        "adapter_code_change_valid": validation["status"] == "valid",
        "dry_run_does_not_enable_adapter": request.dry_run is True,
    }
    can_record = all(checks.values())
    code_change_payload = {
        key: value
        for key, value in raw_code_change.items()
        if value is not None
    }
    audit_record = None
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.adapter_code_change_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.operator_id,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "adapter_code_change": code_change_payload,
                "adapter_implementation_preflight_record": implementation_preflight,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        "stage": "runtime_flag_application_adapter_code_change_workflow",
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/code-change/record",
        "adapter_code_change_id": request.adapter_code_change_id,
        "approval_id": request.approval_id,
        "adapter_implementation_preflight_id": request.adapter_implementation_preflight_id,
        "adapter_implementation_preflight_audit_id": request.adapter_implementation_preflight_audit_id,
        ...
        "validation": validation,
        "audit_event_recorded": audit_record is not None,
        "audit_action": "sdk.write_runner.runtime_flag_application_adapter_code_change_recorded",
        "audit_id": getattr(audit_record, "id", None) if audit_record else None,
        "audit_hash": getattr(audit_record, "hash", None) if audit_record else None,
        "audit_signature_present": bool(getattr(audit_record, "signature", None)) if audit_record else False,
        "runtime_flag_enabled": False,
        ...
        "adapter_execution_allowed": False,
        "known_limits": [
            "This endpoint records the disabled adapter code-change gate only.",
            "It does not import, instantiate, enable, or execute the adapter.",
            "Runtime flag application and SDK write-runner execution remain separate owner-gated follow-ups.",
        ],
    }


def _sdk_runtime_flag_application_adapter_wiring_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        "adapter_wiring_id",
    ...
    checks = {
        ...
        "wired_at_rfc3339": bool(
            isinstance(record, dict) and _is_rfc3339_timestamp(record.get("wired_at"))
        ),
        "runtime_flag_name_allowed": bool(
            isinstance(record, dict)
            and record.get("runtime_flag_name") == "XAGENT_SDK_WRITE_RUNNER_ENABLED"
        ...
        "wiring_plan_ref_present": bool(isinstance(record, dict) and record.get("wiring_plan_ref")),
        "implementation_branch_ref_present": bool(
            isinstance(record, dict) and record.get("implementation_branch_ref")
        ),
        "implementation_plan_ref_present": bool(
        ...
        "signature_or_hash_present": bool(
            isinstance(record, dict) and (record.get("wiring_signature") or record.get("wiring_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_record_runtime_flag_application_adapter_wiring(
    request: SDKRuntimeFlagApplicationAdapterWiringRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    code_change = _sdk_runtime_flag_application_adapter_code_change_record_from_audit(
        audit_store,
        adapter_code_change_id=request.adapter_code_change_id,
        approval_id=request.approval_id,
        adapter_implementation_preflight_id=request.adapter_implementation_preflight_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.adapter_code_change_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_wiring = {
        "adapter_wiring_id": request.adapter_wiring_id,
        "approval_id": request.approval_id,
        "adapter_code_change_id": request.adapter_code_change_id,
        "adapter_code_change_audit_id": request.adapter_code_change_audit_id,
        "adapter_implementation_preflight_id": request.adapter_implementation_preflight_id,
        "adapter_design_review_id": request.adapter_design_review_id,
        "adapter_implementation_request_id": request.adapter_implementation_request_id,
        "readiness_plan_decision_id": request.readiness_plan_decision_id,
        ...
        "runtime_flag_name": request.runtime_flag_name,
        "operator_id": request.operator_id,
        "wired_at": request.wired_at,
        "adapter_module": request.adapter_module,
        "adapter_class": request.adapter_class,
        "wiring_plan_ref": request.wiring_plan_ref,
        "implementation_branch_ref": request.implementation_branch_ref,
        "implementation_plan_ref": request.implementation_plan_ref,
        "adapter_design_ref": request.adapter_design_ref,
        "security_review_ref": request.security_review_ref,
        ...
        "idempotency_key": request.idempotency_key,
        "idempotency_hash": request.idempotency_hash,
        "wiring_signature": request.wiring_signature,
        "wiring_hash": request.wiring_hash,
        "notes": request.notes,
    }
    validation = _sdk_runtime_flag_application_adapter_wiring_validation(raw_wiring)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "adapter_code_change_audit_record_present": isinstance(code_change, dict),
        "adapter_code_change_validation_valid": bool(
            isinstance(code_change, dict)
            and _sdk_runtime_flag_application_adapter_code_change_validation(code_change)["status"] == "valid"
        ),
        "adapter_code_change_outcome_accepted": bool(
            isinstance(code_change, dict) and code_change.get("record_outcome") == "accepted"
        ),
        "adapter_wiring_valid": validation["status"] == "valid",
        "dry_run_does_not_wire_adapter": request.dry_run is True,
    }
    can_record = all(checks.values())
    wiring_payload = {
        key: value
        for key, value in raw_wiring.items()
        if value is not None
    }
    audit_record = None
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.adapter_wiring_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.operator_id,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "adapter_wiring": wiring_payload,
                "adapter_code_change_record": code_change,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        "stage": "runtime_flag_application_adapter_wiring_workflow",
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/wiring/record",
        "adapter_wiring_id": request.adapter_wiring_id,
        "approval_id": request.approval_id,
        "adapter_code_change_id": request.adapter_code_change_id,
        "adapter_code_change_audit_id": request.adapter_code_change_audit_id,
        ...
        "validation": validation,
        "audit_event_recorded": audit_record is not None,
        "audit_action": "sdk.write_runner.runtime_flag_application_adapter_wiring_recorded",
        "audit_id": getattr(audit_record, "id", None) if audit_record else None,
        "audit_hash": getattr(audit_record, "hash", None) if audit_record else None,
        "audit_signature_present": bool(getattr(audit_record, "signature", None)) if audit_record else False,
        "runtime_flag_enabled": False,
        ...
        "instantiates_adapter_in_sdk_invoke": False,
        "known_limits": [
            "This endpoint records the disabled adapter wiring gate only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "Runtime flag application and SDK write-runner execution remain separate owner-gated follow-ups.",
        ],
    }


def _sdk_runtime_flag_application_adapter_runtime_preflight_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        "adapter_runtime_preflight_id",
        "approval_id",
        "adapter_wiring_id",
        "adapter_wiring_audit_id",
        "adapter_code_change_id",
        "adapter_implementation_preflight_id",
        "adapter_design_review_id",
        "adapter_implementation_request_id",
    ...
    checks = {
        ...
        "preflighted_at_rfc3339": bool(
            isinstance(record, dict) and _is_rfc3339_timestamp(record.get("preflighted_at"))
        ),
        "runtime_flag_name_allowed": bool(
            isinstance(record, dict)
            and record.get("runtime_flag_name") == "XAGENT_SDK_WRITE_RUNNER_ENABLED"
        ...
        "runtime_preflight_plan_ref_present": bool(
            isinstance(record, dict) and record.get("runtime_preflight_plan_ref")
        ),
        "wiring_plan_ref_present": bool(isinstance(record, dict) and record.get("wiring_plan_ref")),
        "implementation_branch_ref_present": bool(
            isinstance(record, dict) and record.get("implementation_branch_ref")
        ...
        "signature_or_hash_present": bool(
            isinstance(record, dict)
            and (record.get("runtime_preflight_signature") or record.get("runtime_preflight_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_record_runtime_flag_application_adapter_runtime_preflight(
    request: SDKRuntimeFlagApplicationAdapterRuntimePreflightRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    wiring = _sdk_runtime_flag_application_adapter_wiring_record_from_audit(
        audit_store,
        adapter_wiring_id=request.adapter_wiring_id,
        approval_id=request.approval_id,
        adapter_code_change_id=request.adapter_code_change_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.adapter_wiring_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_runtime_preflight = {
        "adapter_runtime_preflight_id": request.adapter_runtime_preflight_id,
        "approval_id": request.approval_id,
        "adapter_wiring_id": request.adapter_wiring_id,
        "adapter_wiring_audit_id": request.adapter_wiring_audit_id,
        "adapter_code_change_id": request.adapter_code_change_id,
        "adapter_implementation_preflight_id": request.adapter_implementation_preflight_id,
        "adapter_design_review_id": request.adapter_design_review_id,
        "adapter_implementation_request_id": request.adapter_implementation_request_id,
        ...
        "runtime_flag_name": request.runtime_flag_name,
        "operator_id": request.operator_id,
        "preflighted_at": request.preflighted_at,
        "adapter_module": request.adapter_module,
        "adapter_class": request.adapter_class,
        "runtime_preflight_plan_ref": request.runtime_preflight_plan_ref,
        "wiring_plan_ref": request.wiring_plan_ref,
        "implementation_branch_ref": request.implementation_branch_ref,
        "implementation_plan_ref": request.implementation_plan_ref,
        "adapter_design_ref": request.adapter_design_ref,
        ...
        "idempotency_key": request.idempotency_key,
        "idempotency_hash": request.idempotency_hash,
        "runtime_preflight_signature": request.runtime_preflight_signature,
        "runtime_preflight_hash": request.runtime_preflight_hash,
        "notes": request.notes,
    }
    validation = _sdk_runtime_flag_application_adapter_runtime_preflight_validation(raw_runtime_preflight)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "adapter_wiring_audit_record_present": isinstance(wiring, dict),
        "adapter_wiring_validation_valid": bool(
            isinstance(wiring, dict)
            and _sdk_runtime_flag_application_adapter_wiring_validation(wiring)["status"] == "valid"
        ),
        "adapter_wiring_outcome_accepted": bool(
            isinstance(wiring, dict) and wiring.get("record_outcome") == "accepted"
        ),
        "adapter_runtime_preflight_valid": validation["status"] == "valid",
        "dry_run_does_not_start_runtime": request.dry_run is True,
    }
    can_record = all(checks.values())
    runtime_preflight_payload = {
        key: value
        for key, value in raw_runtime_preflight.items()
        if value is not None
    }
    audit_record = None
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.adapter_runtime_preflight_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.operator_id,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "adapter_runtime_preflight": runtime_preflight_payload,
                "adapter_wiring_record": wiring,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        "stage": "runtime_flag_application_adapter_runtime_preflight_workflow",
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/runtime-preflight/record",
        "adapter_runtime_preflight_id": request.adapter_runtime_preflight_id,
        "approval_id": request.approval_id,
        "adapter_wiring_id": request.adapter_wiring_id,
        "adapter_wiring_audit_id": request.adapter_wiring_audit_id,
        ...
        "validation": validation,
        "audit_event_recorded": audit_record is not None,
        "audit_action": "sdk.write_runner.runtime_flag_application_adapter_runtime_preflight_recorded",
        "audit_id": getattr(audit_record, "id", None) if audit_record else None,
        "audit_hash": getattr(audit_record, "hash", None) if audit_record else None,
        "audit_signature_present": bool(getattr(audit_record, "signature", None)) if audit_record else False,
        "runtime_flag_enabled": False,
        ...
        "instantiates_adapter_in_sdk_invoke": False,
        "known_limits": [
            "This endpoint records the disabled adapter runtime preflight gate only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "Runtime flag application and SDK write-runner invocation remain separate owner-gated follow-ups.",
        ],
    }


def _sdk_runtime_flag_application_adapter_execution_dry_run_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        "adapter_execution_dry_run_id",
        "approval_id",
        "adapter_runtime_preflight_id",
        "adapter_runtime_preflight_audit_id",
        "adapter_wiring_id",
        "adapter_code_change_id",
        "adapter_implementation_preflight_id",
        "adapter_design_review_id",
    ...
    checks = {
        "record_present": isinstance(record, dict),
        "required_fields_present": bool(
            isinstance(record, dict) and all(record.get(field) for field in required_fields)
        ),
        "runtime_flag_name_allowed": bool(
            isinstance(record, dict)
            and record.get("runtime_flag_name") == "XAGENT_SDK_WRITE_RUNNER_ENABLED"
        ),
        "dry_run_started_at_rfc3339": bool(
            isinstance(record, dict) and _is_rfc3339_timestamp(record.get("dry_run_started_at"))
        ),
        "adapter_module_allowed": bool(
            isinstance(record, dict)
            and record.get("adapter_module") == "backend.app.sdk.runtime_flag_application_adapter"
        ...
        "execution_dry_run_plan_ref_present": bool(
            isinstance(record, dict) and record.get("execution_dry_run_plan_ref")
        ),
        "runtime_preflight_plan_ref_present": bool(
            isinstance(record, dict) and record.get("runtime_preflight_plan_ref")
        ),
        ...
        "signature_or_hash_present": bool(
            isinstance(record, dict)
            and (record.get("execution_dry_run_signature") or record.get("execution_dry_run_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_runtime_flag_application_adapter_execution_gate_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        ...
        "approval_id",
        "adapter_execution_dry_run_id",
        "adapter_execution_dry_run_audit_id",
        "adapter_runtime_preflight_id",
        "adapter_wiring_id",
        "adapter_code_change_id",
        "adapter_implementation_preflight_id",
    ...
    checks = {
        ...
        "gated_at_rfc3339": bool(
            isinstance(record, dict) and _is_rfc3339_timestamp(record.get("gated_at"))
        ),
        "adapter_module_allowed": bool(
            isinstance(record, dict)
            and record.get("adapter_module") == "backend.app.sdk.runtime_flag_application_adapter"
        ...
        "execution_gate_plan_ref_present": bool(
            isinstance(record, dict) and record.get("execution_gate_plan_ref")
        ),
        "execution_dry_run_plan_ref_present": bool(
            isinstance(record, dict) and record.get("execution_dry_run_plan_ref")
        ),
        ...
        "signature_or_hash_present": bool(
            isinstance(record, dict)
            and (record.get("execution_gate_signature") or record.get("execution_gate_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_live_write_runner_execution_acceptance_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
        "execution_acceptance_id",
        "approval_id",
        "adapter_execution_gate_id",
        "adapter_execution_gate_audit_id",
        "adapter_execution_dry_run_id",
        "adapter_runtime_preflight_id",
        "adapter_wiring_id",
        "adapter_code_change_id",
    ...
    checks = {
        ...
        "runbook_acknowledged": bool(
            isinstance(record, dict) and record.get("runbook_acknowledged") is True
        ),
        ...
        "execution_acceptance_plan_ref_present": bool(
            isinstance(record, dict) and record.get("execution_acceptance_plan_ref")
        ),
        "execution_gate_plan_ref_present": bool(
            isinstance(record, dict) and record.get("execution_gate_plan_ref")
        ),
        ...
        "signature_or_hash_present": bool(
            isinstance(record, dict)
            and (record.get("acceptance_signature") or record.get("acceptance_hash"))
        ),
    }
    return {
        "status": "valid" if all(checks.values()) else "invalid",
...
def _sdk_live_write_runner_invocation_review_validation(
    record: dict[str, Any] | None,
) -> dict[str, Any]:
    required_fields = [
    ...
    checks = {
        ...
        "invocation_review_plan_ref_present": bool(
            isinstance(record, dict) and record.get("invocation_review_plan_ref")
        ),
        "execution_acceptance_plan_ref_present": bool(
            isinstance(record, dict) and record.get("execution_acceptance_plan_ref")
        ),
...
def _sdk_record_runtime_flag_application_adapter_execution_dry_run(
    request: SDKRuntimeFlagApplicationAdapterExecutionDryRunRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    runtime_preflight = _sdk_runtime_flag_application_adapter_runtime_preflight_record_from_audit(
        audit_store,
        adapter_runtime_preflight_id=request.adapter_runtime_preflight_id,
        approval_id=request.approval_id,
        adapter_wiring_id=request.adapter_wiring_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.adapter_runtime_preflight_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_execution_dry_run = {
        "adapter_execution_dry_run_id": request.adapter_execution_dry_run_id,
        "approval_id": request.approval_id,
        "adapter_runtime_preflight_id": request.adapter_runtime_preflight_id,
        "adapter_runtime_preflight_audit_id": request.adapter_runtime_preflight_audit_id,
        "adapter_wiring_id": request.adapter_wiring_id,
        "adapter_code_change_id": request.adapter_code_change_id,
        "adapter_implementation_preflight_id": request.adapter_implementation_preflight_id,
        "adapter_design_review_id": request.adapter_design_review_id,
        ...
        "runtime_flag_name": request.runtime_flag_name,
        "operator_id": request.operator_id,
        "dry_run_started_at": request.dry_run_started_at,
        "adapter_module": request.adapter_module,
        "adapter_class": request.adapter_class,
        "execution_dry_run_plan_ref": request.execution_dry_run_plan_ref,
        "runtime_preflight_plan_ref": request.runtime_preflight_plan_ref,
        "wiring_plan_ref": request.wiring_plan_ref,
        "implementation_branch_ref": request.implementation_branch_ref,
        "implementation_plan_ref": request.implementation_plan_ref,
        ...
        "idempotency_key": request.idempotency_key,
        "idempotency_hash": request.idempotency_hash,
        "execution_dry_run_signature": request.execution_dry_run_signature,
        "execution_dry_run_hash": request.execution_dry_run_hash,
        "notes": request.notes,
    }
    validation = _sdk_runtime_flag_application_adapter_execution_dry_run_validation(
        raw_execution_dry_run
    )
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    ...
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "adapter_runtime_preflight_audit_record_present": isinstance(runtime_preflight, dict),
        "adapter_runtime_preflight_validation_valid": bool(
            isinstance(runtime_preflight, dict)
            and _sdk_runtime_flag_application_adapter_runtime_preflight_validation(runtime_preflight)["status"]
            == "valid"
        ),
        "adapter_runtime_preflight_outcome_accepted": bool(
            isinstance(runtime_preflight, dict) and runtime_preflight.get("record_outcome") == "accepted"
        ),
        "adapter_execution_dry_run_valid": validation["status"] == "valid",
        "dry_run_does_not_invoke_adapter": request.dry_run is True,
    }
    can_record = all(checks.values())
    execution_dry_run_payload = {
        key: value
        for key, value in raw_execution_dry_run.items()
        if value is not None
    }
    audit_record = None
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.adapter_execution_dry_run_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.operator_id,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "adapter_execution_dry_run": execution_dry_run_payload,
                "adapter_runtime_preflight_record": runtime_preflight,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        "stage": "runtime_flag_application_adapter_execution_dry_run_workflow",
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/execution-dry-run/record",
        "adapter_execution_dry_run_id": request.adapter_execution_dry_run_id,
        "approval_id": request.approval_id,
        "adapter_runtime_preflight_id": request.adapter_runtime_preflight_id,
        "adapter_runtime_preflight_audit_id": request.adapter_runtime_preflight_audit_id,
        ...
        "validation": validation,
        "audit_event_recorded": audit_record is not None,
        "audit_action": "sdk.write_runner.runtime_flag_application_adapter_execution_dry_run_recorded",
        "audit_id": getattr(audit_record, "id", None) if audit_record else None,
        "audit_hash": getattr(audit_record, "hash", None) if audit_record else None,
        "audit_signature_present": bool(getattr(audit_record, "signature", None)) if audit_record else False,
        "runtime_flag_enabled": False,
        ...
        "execution_dry_run_invoked": False,
        "known_limits": [
            "This endpoint records the disabled adapter execution dry-run gate only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "SDK write-runner invocation remains a separate owner-gated follow-up.",
        ],
    }


def _sdk_record_runtime_flag_application_adapter_execution_gate(
    request: SDKRuntimeFlagApplicationAdapterExecutionGateRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    execution_dry_run = _sdk_runtime_flag_application_adapter_execution_dry_run_record_from_audit(
        audit_store,
        adapter_execution_dry_run_id=request.adapter_execution_dry_run_id,
        approval_id=request.approval_id,
        adapter_runtime_preflight_id=request.adapter_runtime_preflight_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.adapter_execution_dry_run_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_execution_gate = {
        "adapter_execution_gate_id": request.adapter_execution_gate_id,
        "approval_id": request.approval_id,
        "adapter_execution_dry_run_id": request.adapter_execution_dry_run_id,
        "adapter_execution_dry_run_audit_id": request.adapter_execution_dry_run_audit_id,
        "adapter_runtime_preflight_id": request.adapter_runtime_preflight_id,
        "adapter_wiring_id": request.adapter_wiring_id,
        "adapter_code_change_id": request.adapter_code_change_id,
        "adapter_implementation_preflight_id": request.adapter_implementation_preflight_id,
        ...
        "runtime_flag_name": request.runtime_flag_name,
        "operator_id": request.operator_id,
        "gated_at": request.gated_at,
        "adapter_module": request.adapter_module,
        "adapter_class": request.adapter_class,
        "execution_gate_plan_ref": request.execution_gate_plan_ref,
        "execution_dry_run_plan_ref": request.execution_dry_run_plan_ref,
        "runtime_preflight_plan_ref": request.runtime_preflight_plan_ref,
        "wiring_plan_ref": request.wiring_plan_ref,
        "implementation_branch_ref": request.implementation_branch_ref,
        ...
        "idempotency_key": request.idempotency_key,
        "idempotency_hash": request.idempotency_hash,
        "execution_gate_signature": request.execution_gate_signature,
        "execution_gate_hash": request.execution_gate_hash,
        "notes": request.notes,
    }
    validation = _sdk_runtime_flag_application_adapter_execution_gate_validation(raw_execution_gate)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "adapter_execution_dry_run_audit_record_present": isinstance(execution_dry_run, dict),
        "adapter_execution_dry_run_validation_valid": bool(
            isinstance(execution_dry_run, dict)
            and _sdk_runtime_flag_application_adapter_execution_dry_run_validation(execution_dry_run)["status"]
            == "valid"
        ),
        "adapter_execution_dry_run_outcome_accepted": bool(
            isinstance(execution_dry_run, dict) and execution_dry_run.get("record_outcome") == "accepted"
        ),
        "adapter_execution_dry_run_not_invoked": bool(
            isinstance(execution_dry_run, dict)
            and execution_dry_run.get("execution_dry_run_invoked") is False
        ),
        "adapter_execution_gate_valid": validation["status"] == "valid",
        "dry_run_does_not_open_execution_gate": request.dry_run is True,
    }
    can_record = all(checks.values())
    execution_gate_payload = {
        key: value
        for key, value in raw_execution_gate.items()
        if value is not None
    }
    audit_record = None
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.adapter_execution_gate_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.operator_id,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "adapter_execution_gate": execution_gate_payload,
                "adapter_execution_dry_run_record": execution_dry_run,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        ...
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/execution-gate/record",
        "adapter_execution_gate_id": request.adapter_execution_gate_id,
        "approval_id": request.approval_id,
        "adapter_execution_dry_run_id": request.adapter_execution_dry_run_id,
        "adapter_execution_dry_run_audit_id": request.adapter_execution_dry_run_audit_id,
        ...
        "execution_gate_opened": False,
        "known_limits": [
            "This endpoint records the disabled adapter execution gate only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "SDK write-runner invocation remains a separate owner-gated follow-up.",
        ],
    }
...
def _sdk_record_live_write_runner_execution_acceptance(
    request: SDKLiveWriteRunnerExecutionAcceptanceRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    adapter_execution_gate = _sdk_runtime_flag_application_adapter_execution_gate_record_from_audit(
        audit_store,
        adapter_execution_gate_id=request.adapter_execution_gate_id,
        approval_id=request.approval_id,
        adapter_execution_dry_run_id=request.adapter_execution_dry_run_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.adapter_execution_gate_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_acceptance = {
        "execution_acceptance_id": request.execution_acceptance_id,
        "approval_id": request.approval_id,
        "adapter_execution_gate_id": request.adapter_execution_gate_id,
        "adapter_execution_gate_audit_id": request.adapter_execution_gate_audit_id,
        "adapter_execution_dry_run_id": request.adapter_execution_dry_run_id,
        "adapter_runtime_preflight_id": request.adapter_runtime_preflight_id,
        "adapter_wiring_id": request.adapter_wiring_id,
        "adapter_code_change_id": request.adapter_code_change_id,
        ...
        "adapter_module": request.adapter_module,
        "adapter_class": request.adapter_class,
        "execution_acceptance_plan_ref": request.execution_acceptance_plan_ref,
        "execution_gate_plan_ref": request.execution_gate_plan_ref,
        "execution_dry_run_plan_ref": request.execution_dry_run_plan_ref,
        "runtime_preflight_plan_ref": request.runtime_preflight_plan_ref,
        "wiring_plan_ref": request.wiring_plan_ref,
    ...
    validation = _sdk_live_write_runner_execution_acceptance_validation(raw_acceptance)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "adapter_execution_gate_audit_record_present": isinstance(adapter_execution_gate, dict),
        "adapter_execution_gate_validation_valid": bool(
            isinstance(adapter_execution_gate, dict)
            and _sdk_runtime_flag_application_adapter_execution_gate_validation(adapter_execution_gate)["status"]
            == "valid"
        ),
        "adapter_execution_gate_outcome_accepted": bool(
            isinstance(adapter_execution_gate, dict)
            and adapter_execution_gate.get("record_outcome") == "accepted"
        ),
        "adapter_execution_gate_not_opened": bool(
            isinstance(adapter_execution_gate, dict)
            and adapter_execution_gate.get("execution_gate_opened") is False
        ),
        "execution_acceptance_valid": validation["status"] == "valid",
        "dry_run_does_not_start_live_execution": request.dry_run is True,
    }
    can_record = all(checks.values())
    acceptance_payload = {
        key: value
    ...
    if can_record:
        audit_record = audit_store.record(
            ...
            resource_id=request.execution_acceptance_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.accepted_by,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "live_write_runner_execution_acceptance": acceptance_payload,
                "adapter_execution_gate_record": adapter_execution_gate,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        ...
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/live-write-runner/execution-acceptance/record",
        "execution_acceptance_id": request.execution_acceptance_id,
        "approval_id": request.approval_id,
        "adapter_execution_gate_id": request.adapter_execution_gate_id,
        "adapter_execution_gate_audit_id": request.adapter_execution_gate_audit_id,
        ...
        "execution_gate_opened": False,
        "known_limits": [
            "This endpoint records owner acceptance evidence for a future live write-runner execution only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "It does not invoke the SDK write runner or start live agent execution.",
        ],
    }


def _sdk_record_live_write_runner_invocation_review(
    request: SDKLiveWriteRunnerInvocationReviewRecordRequest,
    *,
    principal: Principal,
    approval_store: object,
    ...
    approval = approval_store.get(request.approval_id) if hasattr(approval_store, "get") else None
    execution_acceptance = _sdk_live_write_runner_execution_acceptance_record_from_audit(
        audit_store,
        execution_acceptance_id=request.execution_acceptance_id,
        approval_id=request.approval_id,
        adapter_execution_gate_id=request.adapter_execution_gate_id,
        ...
        final_decision_id=request.final_decision_id,
        runtime_flag_name=request.runtime_flag_name,
        audit_id=request.execution_acceptance_audit_id,
        tenant_id=principal.tenant_id if principal else None,
    )
    raw_review = {
        "invocation_review_id": request.invocation_review_id,
        "approval_id": request.approval_id,
        "execution_acceptance_id": request.execution_acceptance_id,
        "execution_acceptance_audit_id": request.execution_acceptance_audit_id,
        "adapter_execution_gate_id": request.adapter_execution_gate_id,
        "adapter_execution_gate_audit_id": request.adapter_execution_gate_audit_id,
        "adapter_execution_dry_run_id": request.adapter_execution_dry_run_id,
        "adapter_runtime_preflight_id": request.adapter_runtime_preflight_id,
        ...
        "adapter_module": request.adapter_module,
        "adapter_class": request.adapter_class,
        "invocation_review_plan_ref": request.invocation_review_plan_ref,
        "execution_acceptance_plan_ref": request.execution_acceptance_plan_ref,
        "execution_gate_plan_ref": request.execution_gate_plan_ref,
        "execution_dry_run_plan_ref": request.execution_dry_run_plan_ref,
        "runtime_preflight_plan_ref": request.runtime_preflight_plan_ref,
    ...
    validation = _sdk_live_write_runner_invocation_review_validation(raw_review)
    approval_status = getattr(approval, "status", None)
    approval_status_value = getattr(approval_status, "value", approval_status)
    approval_resource_id = getattr(approval, "resource_id", None)
    approval_tenant_id = getattr(approval, "tenant_id", None)
    checks = {
        ...
        and approval_resource_id.startswith("sdk:"),
        "tenant_matches": not principal.authenticated or approval_tenant_id == principal.tenant_id,
        "execution_acceptance_audit_record_present": isinstance(execution_acceptance, dict),
        "execution_acceptance_validation_valid": bool(
            isinstance(execution_acceptance, dict)
            and _sdk_live_write_runner_execution_acceptance_validation(execution_acceptance)["status"]
            == "valid"
        ),
        "execution_acceptance_outcome_accepted": bool(
            isinstance(execution_acceptance, dict)
            and execution_acceptance.get("record_outcome") == "accepted"
        ),
        "execution_acceptance_did_not_open_execution": bool(
            isinstance(execution_acceptance, dict)
            and execution_acceptance.get("execution_gate_opened") is False
            and execution_acceptance.get("write_runner_invoked") is False
            and execution_acceptance.get("live_execution_started") is False
        ),
        "invocation_review_valid": validation["status"] == "valid",
        "dry_run_does_not_invoke_write_runner": request.dry_run is True,
    }
    can_record = all(checks.values())
    review_payload = {key: value for key, value in raw_review.items() if value is not None}
    audit_record = None
    if can_record:
        audit_record = audit_store.record(
            action="sdk.write_runner.live_write_runner_invocation_review_recorded",
            resource_type="sdk_write_runner_live_write_runner_invocation_review",
            resource_id=request.invocation_review_id,
            outcome="accepted",
            tenant_id=approval_tenant_id or principal.tenant_id,
            actor_id=principal.user_id if principal.authenticated else request.reviewed_by,
            trace_id=trace_id,
            details={
                ...
                "final_decision_id": request.final_decision_id,
                "runtime_flag_name": request.runtime_flag_name,
                "live_write_runner_invocation_review": review_payload,
                "live_write_runner_execution_acceptance_record": execution_acceptance,
                "validation": validation,
                "dry_run": request.dry_run,
                "runtime_flag_enabled": False,
                "flag_application_performed": False,
    ...
    return {
        "stage": "live_write_runner_invocation_review_workflow",
        "record_status": "recorded" if audit_record else "rejected",
        "recording_endpoint": "/api/v1/control-plane/sdk/live-write-runner/invocation-review/record",
        "invocation_review_id": request.invocation_review_id,
        "approval_id": request.approval_id,
        "execution_acceptance_id": request.execution_acceptance_id,
        "execution_acceptance_audit_id": request.execution_acceptance_audit_id,
        ...
        "validation": validation,
        "audit_event_recorded": audit_record is not None,
        "audit_action": "sdk.write_runner.live_write_runner_invocation_review_recorded",
        "audit_id": getattr(audit_record, "id", None) if audit_record else None,
        "audit_hash": getattr(audit_record, "hash", None) if audit_record else None,
        "audit_signature_present": bool(getattr(audit_record, "signature", None)) if audit_record else False,
        "runtime_flag_enabled": False,
        ...
        "execution_gate_opened": False,
        "known_limits": [
            "This endpoint records owner review evidence for a future live write-runner invocation only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "It does not invoke the SDK write runner or start live agent execution.",
        ],
    }
    ...
    *,
    ...
    return {
        ...
        "known_limits": [
            ...
            "Live runtime flag application adapter execution dry-run can be recorded, but it does not invoke the adapter or write runner.",
            "Live write-runner execution owner acceptance can be recorded, but it does not invoke the adapter or write runner.",
...
def _sdk_runtime_flag_application_preflight_workflow_contract(
    runtime_flag_enablement_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "enablement_intent_ready_but_disabled": runtime_flag_enablement_workflow.get("workflow_status")
        == "ready_but_disabled",
        "enablement_intent_does_not_apply_flag": runtime_flag_enablement_workflow.get("decision_effect", {}).get(
            "enables_runtime_flag"
        )
        is False,
        "runtime_flag_still_disabled": runtime_flag_enablement_workflow.get("runtime_flag_enabled") is False,
        "implementation_still_disabled": runtime_flag_enablement_workflow.get("implementation_enabled") is False,
        "runner_not_invoked": runtime_flag_enablement_workflow.get("runner_invoked") is False,
        "mark_executed_disabled": runtime_flag_enablement_workflow.get("mark_executed") is False,
        "mutation_still_disabled": runtime_flag_enablement_workflow.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": runtime_flag_enablement_workflow.get("available") is True,
        "stage": "runtime_flag_application_preflight_record_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        ...
        "channel_mutation_performed": False,
        "known_limits": [
            "This workflow records runtime flag application preflight evidence only.",
            "It does not set XAGENT_SDK_WRITE_RUNNER_ENABLED or start the SDK write runner.",
            "Live runtime flag application remains a separate owner-requested implementation task.",
        ],
    }
...
def _sdk_runtime_flag_application_owner_approval_workflow_contract(
    preflight_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "preflight_ready_but_disabled": preflight_workflow.get("workflow_status") == "ready_but_disabled",
        "preflight_does_not_apply_flag": preflight_workflow.get("decision_effect", {}).get(
            "enables_runtime_flag"
        )
        is False,
        "runtime_flag_still_disabled": preflight_workflow.get("runtime_flag_enabled") is False,
        "flag_application_still_disabled": preflight_workflow.get("flag_application_performed") is False,
        "implementation_still_disabled": preflight_workflow.get("implementation_enabled") is False,
        "runner_not_invoked": preflight_workflow.get("runner_invoked") is False,
        "mark_executed_disabled": preflight_workflow.get("mark_executed") is False,
        "mutation_still_disabled": preflight_workflow.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": preflight_workflow.get("available") is True,
        "stage": "runtime_flag_application_owner_approval_record_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        ...
        "channel_mutation_performed": False,
        "known_limits": [
            "This workflow records an owner accept/reject decision for runtime flag application only.",
            "Accepted owner approvals do not apply XAGENT_SDK_WRITE_RUNNER_ENABLED.",
            "Live runtime flag application remains a separate owner-reviewed execution contract.",
        ],
    }


def _sdk_runtime_flag_application_execute_contract_workflow_contract(
    owner_approval_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "owner_approval_ready_but_disabled": owner_approval_workflow.get("workflow_status")
        == "ready_but_disabled",
        "owner_approval_does_not_apply_flag": owner_approval_workflow.get("decision_effect", {}).get(
            "accepted_enables_runtime_flag"
        )
        is False,
        "runtime_flag_still_disabled": owner_approval_workflow.get("runtime_flag_enabled") is False,
        "flag_application_still_disabled": owner_approval_workflow.get("flag_application_performed") is False,
        "implementation_still_disabled": owner_approval_workflow.get("implementation_enabled") is False,
        "execute_still_disabled": owner_approval_workflow.get("execute_enabled") is False,
        "runner_not_invoked": owner_approval_workflow.get("runner_invoked") is False,
        "mark_executed_disabled": owner_approval_workflow.get("mark_executed") is False,
        "mutation_still_disabled": owner_approval_workflow.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": owner_approval_workflow.get("available") is True,
        "stage": "runtime_flag_application_execute_contract_record_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
...
def _sdk_live_runtime_flag_application_implementation_readiness_plan_contract(
    owner_review: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "owner_review_ready_but_disabled": owner_review.get("review_status") == "ready_but_disabled",
        "manual_review_required": owner_review.get("owner_review_policy", {}).get(
            "manual_review_required"
        )
        is True,
        "independent_review_required": owner_review.get("owner_review_policy", {}).get(
            "independent_review_required"
        )
        is True,
        "explicit_live_application_request_required": owner_review.get("owner_review_policy", {}).get(
            "requires_live_application_request"
        )
        is True,
        "owner_review_cannot_apply_flag": owner_review.get("owner_review_policy", {}).get(
            "can_apply_runtime_flag_after_review"
        )
        is False,
        "owner_review_cannot_invoke_runner": owner_review.get("owner_review_policy", {}).get(
            "can_invoke_write_runner_after_review"
        )
        is False,
        "runtime_flag_still_disabled": owner_review.get("runtime_flag_enabled") is False,
        "runner_not_invoked": owner_review.get("runner_invoked") is False,
        "mutation_still_disabled": owner_review.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": owner_review.get("available") is True,
...
def _sdk_live_runtime_flag_application_adapter_implementation_request_workflow_contract(
    readiness_plan_decision_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "readiness_plan_decision_workflow_ready": (
            readiness_plan_decision_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "readiness_plan_decision_records_accept_or_reject": (
            readiness_plan_decision_workflow.get("requires_decision_accept_or_reject") is True
        ),
        "accepted_decision_does_not_apply_flag": (
            readiness_plan_decision_workflow.get("decision_effect", {}).get("accepted_applies_runtime_flag")
            is False
        ),
        "accepted_decision_does_not_enable_adapter": (
            readiness_plan_decision_workflow.get("decision_effect", {}).get("accepted_enables_adapter")
            is False
        ),
        "runtime_flag_still_disabled": readiness_plan_decision_workflow.get("runtime_flag_enabled") is False,
        "adapter_execution_still_disabled": (
            readiness_plan_decision_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": readiness_plan_decision_workflow.get("runner_invoked") is False,
        "mutation_still_disabled": readiness_plan_decision_workflow.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": readiness_plan_decision_workflow.get("available") is True,
        "stage": "runtime_flag_application_adapter_implementation_request_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        "endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/implementation-request/record",
        "sdk_operation": "runtime_flag_application_adapter_implementation_request_record",
        "cli_command": "xagent sdk runtime-flag-application-adapter-implementation-request-record --execute",
        "requires_approved_sdk_approval": True,
        ...
        "next_gate": "owner_approved_live_runtime_flag_application_adapter_design_review",
        "checks": checks,
        "implementation_enabled": False,
        "runtime_flag_enabled": False,
        "flag_application_performed": False,
        ...
        "adapter_execution_allowed": False,
        "known_limits": [
            "This workflow records a separate explicit owner request to start adapter implementation only.",
            "Recording the request does not implement, import, instantiate, or execute the adapter.",
            "Runtime flag application and SDK write-runner execution remain separate owner-gated follow-ups.",
        ],
    }


def _sdk_live_runtime_flag_application_adapter_design_review_workflow_contract(
    adapter_implementation_request_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "adapter_implementation_request_workflow_ready": (
            adapter_implementation_request_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "implementation_request_requires_owner_approval": (
            adapter_implementation_request_workflow.get("requires_approved_sdk_approval") is True
        ),
        "implementation_request_requires_accepted_readiness_decision": (
            adapter_implementation_request_workflow.get("requires_accepted_readiness_plan_decision") is True
        ),
        "implementation_request_does_not_implement_adapter": (
            adapter_implementation_request_workflow.get("request_effect", {}).get("implements_adapter")
            is False
        ),
        "implementation_request_does_not_import_adapter": (
            adapter_implementation_request_workflow.get("request_effect", {}).get("imports_adapter")
            is False
        ),
        "runtime_flag_still_disabled": (
            adapter_implementation_request_workflow.get("runtime_flag_enabled") is False
        ),
        "adapter_execution_still_disabled": (
            adapter_implementation_request_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": adapter_implementation_request_workflow.get("runner_invoked") is False,
        "mutation_still_disabled": adapter_implementation_request_workflow.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": adapter_implementation_request_workflow.get("available") is True,
        "stage": "runtime_flag_application_adapter_design_review_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        ...
        "adapter_execution_allowed": False,
        "known_limits": [
            "This workflow records owner design review for the future live runtime flag adapter only.",
            "Accepted design reviews do not implement, import, instantiate, or execute the adapter.",
            "Runtime flag application and SDK write-runner execution remain separate owner-gated follow-ups.",
        ],
    }
...
def _sdk_live_runtime_flag_application_adapter_code_change_workflow_contract(
    adapter_implementation_preflight_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "adapter_implementation_preflight_workflow_ready": (
            adapter_implementation_preflight_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "preflight_requires_owner_approval": (
            adapter_implementation_preflight_workflow.get("requires_approved_sdk_approval") is True
        ),
        "preflight_requires_accepted_design_review": (
            adapter_implementation_preflight_workflow.get("requires_accepted_adapter_design_review") is True
        ),
        "accepted_preflight_does_not_implement_adapter": (
            adapter_implementation_preflight_workflow.get("preflight_effect", {}).get("implements_adapter")
            is False
        ),
        "accepted_preflight_does_not_write_adapter_files": (
            adapter_implementation_preflight_workflow.get("preflight_effect", {}).get("writes_adapter_files")
            is False
        ),
        "runtime_flag_still_disabled": (
            adapter_implementation_preflight_workflow.get("runtime_flag_enabled") is False
        ),
        "adapter_execution_still_disabled": (
            adapter_implementation_preflight_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": adapter_implementation_preflight_workflow.get("runner_invoked") is False,
        "mutation_still_disabled": adapter_implementation_preflight_workflow.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": adapter_implementation_preflight_workflow.get("available") is True,
        "stage": "runtime_flag_application_adapter_code_change_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        "endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/code-change/record",
        "sdk_operation": "runtime_flag_application_adapter_code_change_record",
        "cli_command": "xagent sdk runtime-flag-application-adapter-code-change-record --execute",
        "requires_approved_sdk_approval": True,
        ...
        "next_gate": "owner_approved_live_runtime_flag_application_adapter_wiring",
        "implementation_enabled": False,
        "runtime_flag_enabled": False,
        "flag_application_performed": False,
        "execute_enabled": False,
        ...
        "adapter_execution_allowed": False,
        "known_limits": [
            "This workflow records the disabled adapter code-change gate only.",
            "The adapter module exists but is not imported, instantiated, or executed by /sdk/invoke.",
            "Runtime flag application and write-runner wiring remain separate owner-gated follow-ups.",
        ],
    }


def _sdk_live_runtime_flag_application_adapter_wiring_workflow_contract(
    adapter_code_change_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "adapter_code_change_workflow_ready": (
            adapter_code_change_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "code_change_requires_owner_approval": (
            adapter_code_change_workflow.get("requires_approved_sdk_approval") is True
        ),
        "code_change_requires_accepted_preflight": (
            adapter_code_change_workflow.get("requires_accepted_adapter_implementation_preflight") is True
        ),
        "code_change_adds_module_without_runtime_wiring": (
            adapter_code_change_workflow.get("code_change_effect", {}).get("adapter_module_added") is True
            and adapter_code_change_workflow.get("code_change_effect", {}).get("adapter_runtime_wired") is False
        ),
        "code_change_does_not_import_adapter": (
            adapter_code_change_workflow.get("code_change_effect", {}).get("imports_adapter_in_sdk_invoke")
            is False
        ),
        "code_change_does_not_instantiate_adapter": (
            adapter_code_change_workflow.get("code_change_effect", {}).get("instantiates_adapter_in_sdk_invoke")
            is False
        ),
        "runtime_flag_still_disabled": adapter_code_change_workflow.get("runtime_flag_enabled") is False,
        "adapter_execution_still_disabled": (
            adapter_code_change_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": adapter_code_change_workflow.get("runner_invoked") is False,
        "mutation_still_disabled": adapter_code_change_workflow.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": adapter_code_change_workflow.get("available") is True,
        "stage": "runtime_flag_application_adapter_wiring_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        "endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/wiring/record",
        "sdk_operation": "runtime_flag_application_adapter_wiring_record",
        "cli_command": "xagent sdk runtime-flag-application-adapter-wiring-record --execute",
        "requires_approved_sdk_approval": True,
        ...
        "next_gate": "owner_approved_live_runtime_flag_application_adapter_runtime_preflight",
        "implementation_enabled": False,
        "runtime_flag_enabled": False,
        "flag_application_performed": False,
        "execute_enabled": False,
        ...
        "instantiates_adapter_in_sdk_invoke": False,
        "known_limits": [
            "This workflow records owner-approved adapter wiring intent only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "Runtime preflight and write-runner invocation remain separate owner-gated follow-ups.",
        ],
        "checks": checks,
    }


def _sdk_live_runtime_flag_application_adapter_runtime_preflight_workflow_contract(
    adapter_wiring_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "adapter_wiring_workflow_ready": (
            adapter_wiring_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "wiring_requires_owner_approval": (
            adapter_wiring_workflow.get("requires_approved_sdk_approval") is True
        ),
        "wiring_requires_accepted_code_change": (
            adapter_wiring_workflow.get("requires_accepted_adapter_code_change") is True
        ),
        "wiring_record_does_not_wire_runtime": (
            adapter_wiring_workflow.get("wiring_effect", {}).get("wired_into_sdk_invoke") is False
            and adapter_wiring_workflow.get("wiring_effect", {}).get("adapter_runtime_wired") is False
        ),
        "wiring_does_not_import_adapter": (
            adapter_wiring_workflow.get("wiring_effect", {}).get("imports_adapter_in_sdk_invoke") is False
        ),
        "wiring_does_not_instantiate_adapter": (
            adapter_wiring_workflow.get("wiring_effect", {}).get("instantiates_adapter_in_sdk_invoke")
            is False
        ),
        "runtime_flag_still_disabled": adapter_wiring_workflow.get("runtime_flag_enabled") is False,
        "adapter_execution_still_disabled": (
            adapter_wiring_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": adapter_wiring_workflow.get("runner_invoked") is False,
        "mutation_still_disabled": adapter_wiring_workflow.get("mutation_performed") is False,
    }
    ready = all(checks.values())
    return {
        "available": adapter_wiring_workflow.get("available") is True,
        "stage": "runtime_flag_application_adapter_runtime_preflight_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        "endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/runtime-preflight/record",
        "sdk_operation": "runtime_flag_application_adapter_runtime_preflight_record",
        "cli_command": "xagent sdk runtime-flag-application-adapter-runtime-preflight-record --execute",
        "requires_approved_sdk_approval": True,
        ...
        "next_gate": "owner_approved_live_runtime_flag_application_adapter_execution_dry_run",
        "implementation_enabled": False,
        "runtime_flag_enabled": False,
        "flag_application_performed": False,
        "execute_enabled": False,
        ...
        "instantiates_adapter_in_sdk_invoke": False,
        "known_limits": [
            "This workflow records runtime preflight intent only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "Execution dry-run and write-runner invocation remain separate owner-gated follow-ups.",
        ],
        "checks": checks,
    }


def _sdk_live_runtime_flag_application_adapter_execution_dry_run_workflow_contract(
    adapter_runtime_preflight_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "adapter_runtime_preflight_workflow_ready": (
            adapter_runtime_preflight_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "runtime_preflight_requires_owner_approval": (
            adapter_runtime_preflight_workflow.get("requires_approved_sdk_approval") is True
        ),
        "runtime_preflight_requires_accepted_wiring": (
            adapter_runtime_preflight_workflow.get("requires_accepted_adapter_wiring") is True
        ),
        "runtime_preflight_record_does_not_wire_runtime": (
            adapter_runtime_preflight_workflow.get("runtime_preflight_effect", {}).get(
                "wired_into_sdk_invoke"
            )
            is False
            and adapter_runtime_preflight_workflow.get("runtime_preflight_effect", {}).get(
                "adapter_runtime_wired"
            )
            is False
        ),
        "runtime_preflight_does_not_import_adapter": (
            adapter_runtime_preflight_workflow.get("runtime_preflight_effect", {}).get(
                "imports_adapter_in_sdk_invoke"
            )
            is False
        ),
        "runtime_preflight_does_not_instantiate_adapter": (
            adapter_runtime_preflight_workflow.get("runtime_preflight_effect", {}).get(
        ...
        "runtime_flag_still_disabled": (
            adapter_runtime_preflight_workflow.get("runtime_flag_enabled") is False
        ),
        "adapter_execution_still_disabled": (
            adapter_runtime_preflight_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": adapter_runtime_preflight_workflow.get("runner_invoked") is False,
        "mutation_still_disabled": (
            adapter_runtime_preflight_workflow.get("mutation_performed") is False
        ),
    }
    ready = all(checks.values())
    return {
        "available": adapter_runtime_preflight_workflow.get("available") is True,
        "stage": "runtime_flag_application_adapter_execution_dry_run_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        "endpoint": "/api/v1/control-plane/sdk/runtime-flag/application-adapter/execution-dry-run/record",
        "sdk_operation": "runtime_flag_application_adapter_execution_dry_run_record",
        "cli_command": "xagent sdk runtime-flag-application-adapter-execution-dry-run-record --execute",
        "requires_approved_sdk_approval": True,
        "requires_accepted_adapter_runtime_preflight": True,
        "requires_adapter_runtime_preflight_audit": True,
        "requires_runtime_flag_name": "XAGENT_SDK_WRITE_RUNNER_ENABLED",
        "requires_adapter_module": "backend.app.sdk.runtime_flag_application_adapter",
        "requires_adapter_class": "SDKRuntimeFlagApplicationAdapter",
        ...
        "resource_type": "sdk_write_runner_runtime_flag_application_adapter_execution_dry_run",
        "audit_event_recorded_by_sdk_invoke": False,
        "execution_dry_run_effect": {
            "execution_dry_run_recorded": True,
            "wired_into_sdk_invoke": False,
            "adapter_runtime_wired": False,
            "imports_adapter_in_sdk_invoke": False,
            "instantiates_adapter_in_sdk_invoke": False,
        ...
        "next_gate": "owner_approved_live_runtime_flag_application_adapter_execution",
        "implementation_enabled": False,
        "runtime_flag_enabled": False,
        "flag_application_performed": False,
        "execute_enabled": False,
        ...
        "execution_dry_run_invoked": False,
        "known_limits": [
            "This workflow records owner-approved adapter execution dry-run intent only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "Live adapter execution and write-runner invocation remain separate owner-gated follow-ups.",
        ],
        "checks": checks,
    }


def _sdk_live_runtime_flag_application_adapter_execution_gate_workflow_contract(
    adapter_execution_dry_run_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "adapter_execution_dry_run_workflow_ready": (
            adapter_execution_dry_run_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "execution_dry_run_requires_owner_approval": (
            adapter_execution_dry_run_workflow.get("requires_approved_sdk_approval") is True
        ),
        "execution_dry_run_requires_accepted_runtime_preflight": (
            adapter_execution_dry_run_workflow.get("requires_accepted_adapter_runtime_preflight")
            is True
        ),
        "execution_dry_run_recorded_without_execution": (
            adapter_execution_dry_run_workflow.get("execution_dry_run_effect", {}).get(
                "execution_dry_run_recorded"
            )
            is True
            and adapter_execution_dry_run_workflow.get("execution_dry_run_effect", {}).get(
                "execution_dry_run_invoked"
            )
            is False
        ),
        "execution_dry_run_does_not_wire_runtime": (
            adapter_execution_dry_run_workflow.get("execution_dry_run_effect", {}).get(
                "wired_into_sdk_invoke"
            )
            is False
        ...
        "execution_dry_run_does_not_import_adapter": (
            adapter_execution_dry_run_workflow.get("execution_dry_run_effect", {}).get(
                "imports_adapter_in_sdk_invoke"
            )
            is False
        ),
        "execution_dry_run_does_not_instantiate_adapter": (
            adapter_execution_dry_run_workflow.get("execution_dry_run_effect", {}).get(
                "instantiates_adapter_in_sdk_invoke"
            )
            is False
        ...
        "runtime_flag_still_disabled": (
            adapter_execution_dry_run_workflow.get("runtime_flag_enabled") is False
        ),
        "adapter_execution_still_disabled": (
            adapter_execution_dry_run_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": adapter_execution_dry_run_workflow.get("runner_invoked") is False,
        "mutation_still_disabled": (
            adapter_execution_dry_run_workflow.get("mutation_performed") is False
        ),
    }
    ready = all(checks.values())
    return {
        "available": adapter_execution_dry_run_workflow.get("available") is True,
        "stage": "runtime_flag_application_adapter_execution_gate_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        ...
        "execution_gate_opened": False,
        "known_limits": [
            "This workflow records owner-approved adapter execution gate intent only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "Live write-runner invocation remains a separate owner-gated follow-up.",
        ],
        "checks": checks,
    }


def _sdk_live_write_runner_execution_acceptance_workflow_contract(
    adapter_execution_gate_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "adapter_execution_gate_workflow_ready": (
            adapter_execution_gate_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "execution_gate_requires_owner_approval": (
            adapter_execution_gate_workflow.get("requires_approved_sdk_approval") is True
        ),
        "execution_gate_requires_accepted_dry_run": (
            adapter_execution_gate_workflow.get("requires_accepted_adapter_execution_dry_run")
            is True
        ),
        "execution_gate_recorded_without_opening": (
            adapter_execution_gate_workflow.get("execution_gate_effect", {}).get(
                "execution_gate_recorded"
            )
            is True
            and adapter_execution_gate_workflow.get("execution_gate_effect", {}).get(
                "execution_gate_opened"
            )
            is False
        ),
        "execution_gate_does_not_wire_runtime": (
            adapter_execution_gate_workflow.get("execution_gate_effect", {}).get(
                "wired_into_sdk_invoke"
            )
            is False
        ...
        "execution_gate_does_not_import_adapter": (
            adapter_execution_gate_workflow.get("execution_gate_effect", {}).get(
                "imports_adapter_in_sdk_invoke"
            )
            is False
        ),
        "execution_gate_does_not_instantiate_adapter": (
            adapter_execution_gate_workflow.get("execution_gate_effect", {}).get(
                "instantiates_adapter_in_sdk_invoke"
            )
            is False
        ...
        "runtime_flag_still_disabled": (
            adapter_execution_gate_workflow.get("runtime_flag_enabled") is False
        ),
        "adapter_execution_still_disabled": (
            adapter_execution_gate_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": adapter_execution_gate_workflow.get("runner_invoked") is False,
        "execution_gate_still_closed": (
            adapter_execution_gate_workflow.get("execution_gate_opened") is False
        ),
        "mutation_still_disabled": (
            adapter_execution_gate_workflow.get("mutation_performed") is False
        ),
    }
    ready = all(checks.values())
    return {
        "available": adapter_execution_gate_workflow.get("available") is True,
        "stage": "live_write_runner_execution_acceptance_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        ...
        "execution_gate_opened": False,
        "known_limits": [
            "This workflow records owner acceptance evidence for future live SDK write-runner execution only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "Live write-runner invocation remains disabled until a separate explicit execution approval.",
        ],
        "checks": checks,
    }


def _sdk_live_write_runner_invocation_review_workflow_contract(
    execution_acceptance_workflow: dict[str, Any],
) -> dict[str, Any]:
    checks = {
        "execution_acceptance_workflow_ready": (
            execution_acceptance_workflow.get("workflow_status") == "ready_but_disabled"
        ),
        "execution_acceptance_requires_owner_approval": (
            execution_acceptance_workflow.get("requires_approved_sdk_approval") is True
        ),
        "execution_acceptance_requires_adapter_execution_gate": (
            execution_acceptance_workflow.get("requires_accepted_adapter_execution_gate") is True
        ),
        "execution_acceptance_recorded_without_invocation": (
            execution_acceptance_workflow.get("execution_acceptance_effect", {}).get(
                "execution_acceptance_recorded"
            )
            is True
            and execution_acceptance_workflow.get("execution_acceptance_effect", {}).get(
                "write_runner_invoked"
            )
            is False
            and execution_acceptance_workflow.get("execution_acceptance_effect", {}).get(
        ...
        "execution_acceptance_does_not_wire_runtime": (
            execution_acceptance_workflow.get("execution_acceptance_effect", {}).get(
                "wired_into_sdk_invoke"
            )
            is False
        ...
        "execution_acceptance_does_not_import_adapter": (
            execution_acceptance_workflow.get("execution_acceptance_effect", {}).get(
                "imports_adapter_in_sdk_invoke"
            )
            is False
        ),
        "execution_acceptance_does_not_instantiate_adapter": (
            execution_acceptance_workflow.get("execution_acceptance_effect", {}).get(
                "instantiates_adapter_in_sdk_invoke"
            )
            is False
        ...
        "runtime_flag_still_disabled": (
            execution_acceptance_workflow.get("runtime_flag_enabled") is False
        ),
        "adapter_execution_still_disabled": (
            execution_acceptance_workflow.get("adapter_execution_enabled") is False
        ),
        "runner_not_invoked": execution_acceptance_workflow.get("runner_invoked") is False,
        "execution_gate_still_closed": (
            execution_acceptance_workflow.get("execution_gate_opened") is False
        ),
        "mutation_still_disabled": (
            execution_acceptance_workflow.get("mutation_performed") is False
        ),
    }
    ready = all(checks.values())
    return {
        "available": execution_acceptance_workflow.get("available") is True,
        "stage": "live_write_runner_invocation_review_workflow",
        "workflow_status": "ready_but_disabled" if ready else "blocked",
        "endpoint": "/api/v1/control-plane/sdk/live-write-runner/invocation-review/record",
        "sdk_operation": "live_write_runner_invocation_review_record",
        "cli_command": "xagent sdk live-write-runner-invocation-review-record --execute",
        "requires_approved_sdk_approval": True,
        "requires_accepted_execution_acceptance": True,
        "requires_execution_acceptance_audit": True,
        "requires_runtime_flag_name": "XAGENT_SDK_WRITE_RUNNER_ENABLED",
        "requires_adapter_module": "backend.app.sdk.runtime_flag_application_adapter",
        "requires_adapter_class": "SDKRuntimeFlagApplicationAdapter",
        "requires_invocation_review_plan_ref": True,
        "requires_execution_acceptance_plan_ref": True,
        "requires_execution_gate_plan_ref": True,
        "requires_execution_dry_run_plan_ref": True,
        "requires_runtime_preflight_plan_ref": True,
        ...
        "resource_type": "sdk_write_runner_live_write_runner_invocation_review",
        "audit_event_recorded_by_sdk_invoke": False,
        "invocation_review_effect": {
            "invocation_review_recorded": True,
            "execution_gate_opened": False,
            "wired_into_sdk_invoke": False,
            "adapter_runtime_wired": False,
            "imports_adapter_in_sdk_invoke": False,
        ...
        "next_gate": "explicit_owner_live_write_runner_invocation_execute",
        "implementation_enabled": False,
        "runtime_flag_enabled": False,
        "flag_application_performed": False,
        "execute_enabled": False,
        ...
        "execution_gate_opened": False,
        "known_limits": [
            "This workflow records owner review evidence for future live SDK write-runner invocation only.",
            "It does not wire the adapter into /sdk/invoke, import it, instantiate it, or execute it.",
            "Live write-runner invocation remains disabled until a separate explicit execution gate is accepted.",
        ],
        "checks": checks,
    }
...
def _sdk_runtime_flag_enablement_record_from_audit(
    audit_store: AuditStore | None,
    *,
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if runtime_flag_enablement_id and getattr(record, "resource_id", None) != runtime_flag_enablement_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        enablement = details.get("runtime_flag_enablement")
        if not isinstance(enablement, dict):
            continue
        if runtime_flag_name and enablement.get("runtime_flag_name") != runtime_flag_name:
            continue
        return {
            **_jsonable(enablement),
            "audit_id": getattr(record, "id", audit_id),
            "audit_created_at": _jsonable(getattr(record, "created_at", None)),
            "audit_hash": getattr(record, "hash", None),
            "audit_signature_present": bool(getattr(record, "signature", None)),
...
def _sdk_runtime_flag_application_preflight_record_from_audit(
    audit_store: AuditStore | None,
    *,
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if runtime_flag_preflight_id and getattr(record, "resource_id", None) != runtime_flag_preflight_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        preflight = details.get("runtime_flag_preflight")
        if not isinstance(preflight, dict):
            continue
        if runtime_flag_name and preflight.get("runtime_flag_name") != runtime_flag_name:
            continue
        return {
            **_jsonable(preflight),
            "audit_id": getattr(record, "id", audit_id),
...
def _sdk_runtime_flag_application_owner_approval_record_from_audit(
    audit_store: AuditStore | None,
    *,
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if runtime_flag_approval_id and getattr(record, "resource_id", None) != runtime_flag_approval_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        approval = details.get("runtime_flag_owner_approval")
        if not isinstance(approval, dict):
            continue
        if runtime_flag_name and approval.get("runtime_flag_name") != runtime_flag_name:
            continue
...
def _sdk_runtime_flag_application_readiness_plan_decision_record_from_audit(
    audit_store: AuditStore | None,
    *,
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if readiness_plan_decision_id and getattr(record, "resource_id", None) != readiness_plan_decision_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        decision = details.get("readiness_plan_decision")
        if not isinstance(decision, dict):
            continue
        if runtime_flag_name and decision.get("runtime_flag_name") != runtime_flag_name:
            continue
...
def _sdk_runtime_flag_application_adapter_implementation_request_record_from_audit(
    audit_store: AuditStore | None,
    *,
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if adapter_implementation_request_id and getattr(record, "resource_id", None) != adapter_implementation_request_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        implementation_request = details.get("adapter_implementation_request")
        if not isinstance(implementation_request, dict):
            continue
        if runtime_flag_name and implementation_request.get("runtime_flag_name") != runtime_flag_name:
            continue
        return {
...
def _sdk_runtime_flag_application_adapter_implementation_preflight_record_from_audit(
    audit_store: AuditStore | None,
    *,
    adapter_implementation_preflight_id: str | None,
    approval_id: str | None,
    adapter_design_review_id: str | None,
    adapter_implementation_request_id: str | None,
    readiness_plan_decision_id: str | None,
    ...
    if (
        audit_store is None
        or not adapter_implementation_preflight_id
        or not approval_id
        or not adapter_design_review_id
        or not adapter_implementation_request_id
        or not readiness_plan_decision_id
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if adapter_implementation_preflight_id and getattr(record, "resource_id", None) != adapter_implementation_preflight_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        if adapter_design_review_id and details.get("adapter_design_review_id") != adapter_design_review_id:
            continue
        if adapter_implementation_request_id and details.get("adapter_implementation_request_id") != adapter_implementation_request_id:
            continue
        if readiness_plan_decision_id and details.get("readiness_plan_decision_id") != readiness_plan_decision_id:
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        preflight = details.get("adapter_implementation_preflight")
        if not isinstance(preflight, dict):
            continue
        if runtime_flag_name and preflight.get("runtime_flag_name") != runtime_flag_name:
            continue
...
def _sdk_runtime_flag_application_adapter_code_change_record_from_audit(
    audit_store: AuditStore | None,
    *,
    adapter_code_change_id: str | None,
    approval_id: str | None,
    adapter_implementation_preflight_id: str | None,
    adapter_design_review_id: str | None,
    adapter_implementation_request_id: str | None,
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if adapter_code_change_id and getattr(record, "resource_id", None) != adapter_code_change_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        if adapter_implementation_preflight_id and details.get("adapter_implementation_preflight_id") != adapter_implementation_preflight_id:
            continue
        if adapter_design_review_id and details.get("adapter_design_review_id") != adapter_design_review_id:
            continue
        if adapter_implementation_request_id and details.get("adapter_implementation_request_id") != adapter_implementation_request_id:
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        code_change = details.get("adapter_code_change")
        if not isinstance(code_change, dict):
            continue
        if runtime_flag_name and code_change.get("runtime_flag_name") != runtime_flag_name:
            continue
        return {
            **_jsonable(code_change),
            "record_outcome": getattr(record, "outcome", None),
            "audit_id": getattr(record, "id", audit_id),
            "audit_created_at": _jsonable(getattr(record, "created_at", None)),
            "audit_hash": getattr(record, "hash", None),
...
def _sdk_runtime_flag_application_adapter_wiring_record_from_audit(
    audit_store: AuditStore | None,
    *,
    adapter_wiring_id: str | None,
    approval_id: str | None,
    adapter_code_change_id: str | None,
    adapter_implementation_preflight_id: str | None,
    adapter_design_review_id: str | None,
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if adapter_wiring_id and getattr(record, "resource_id", None) != adapter_wiring_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        if adapter_code_change_id and details.get("adapter_code_change_id") != adapter_code_change_id:
            continue
        if adapter_implementation_preflight_id and details.get("adapter_implementation_preflight_id") != adapter_implementation_preflight_id:
            continue
        if adapter_design_review_id and details.get("adapter_design_review_id") != adapter_design_review_id:
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        wiring = details.get("adapter_wiring")
        if not isinstance(wiring, dict):
            continue
        if runtime_flag_name and wiring.get("runtime_flag_name") != runtime_flag_name:
            continue
        return {
            **_jsonable(wiring),
            "record_outcome": getattr(record, "outcome", None),
...
def _sdk_runtime_flag_application_adapter_runtime_preflight_record_from_audit(
    audit_store: AuditStore | None,
    *,
    adapter_runtime_preflight_id: str | None,
    approval_id: str | None,
    adapter_wiring_id: str | None,
    adapter_code_change_id: str | None,
    adapter_implementation_preflight_id: str | None,
    ...
    if (
        audit_store is None
        or not adapter_runtime_preflight_id
        or not approval_id
        or not adapter_wiring_id
        or not adapter_code_change_id
        or not adapter_implementation_preflight_id
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if adapter_runtime_preflight_id and getattr(record, "resource_id", None) != adapter_runtime_preflight_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        if adapter_wiring_id and details.get("adapter_wiring_id") != adapter_wiring_id:
            continue
        if adapter_code_change_id and details.get("adapter_code_change_id") != adapter_code_change_id:
            continue
        if adapter_implementation_preflight_id and details.get("adapter_implementation_preflight_id") != adapter_implementation_preflight_id:
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        runtime_preflight = details.get("adapter_runtime_preflight")
        if not isinstance(runtime_preflight, dict):
            continue
        if runtime_flag_name and runtime_preflight.get("runtime_flag_name") != runtime_flag_name:
            continue
        return {
            **_jsonable(runtime_preflight),
            "record_outcome": getattr(record, "outcome", None),
            "audit_id": getattr(record, "id", audit_id),
            "audit_created_at": _jsonable(getattr(record, "created_at", None)),
            "audit_hash": getattr(record, "hash", None),
...
def _sdk_runtime_flag_application_adapter_execution_dry_run_record_from_audit(
    audit_store: AuditStore | None,
    *,
    adapter_execution_dry_run_id: str | None,
    approval_id: str | None,
    adapter_runtime_preflight_id: str | None,
    adapter_wiring_id: str | None,
    adapter_code_change_id: str | None,
    ...
    if (
        audit_store is None
        or not adapter_execution_dry_run_id
        or not approval_id
        or not adapter_runtime_preflight_id
        or not adapter_wiring_id
        or not adapter_code_change_id
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if adapter_execution_dry_run_id and getattr(record, "resource_id", None) != adapter_execution_dry_run_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        if adapter_runtime_preflight_id and details.get("adapter_runtime_preflight_id") != adapter_runtime_preflight_id:
            continue
        if adapter_wiring_id and details.get("adapter_wiring_id") != adapter_wiring_id:
            continue
        if adapter_code_change_id and details.get("adapter_code_change_id") != adapter_code_change_id:
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        execution_dry_run = details.get("adapter_execution_dry_run")
        if not isinstance(execution_dry_run, dict):
            continue
        if runtime_flag_name and execution_dry_run.get("runtime_flag_name") != runtime_flag_name:
            continue
        return {
            **_jsonable(execution_dry_run),
            "record_outcome": getattr(record, "outcome", None),
            "audit_id": getattr(record, "id", audit_id),
            "audit_created_at": _jsonable(getattr(record, "created_at", None)),
            "audit_hash": getattr(record, "hash", None),
...
def _sdk_runtime_flag_application_adapter_execution_gate_record_from_audit(
    audit_store: AuditStore | None,
    *,
    adapter_execution_gate_id: str | None,
    approval_id: str | None,
    adapter_execution_dry_run_id: str | None,
    adapter_runtime_preflight_id: str | None,
    adapter_wiring_id: str | None,
    ...
    if (
        audit_store is None
        or not adapter_execution_gate_id
        or not approval_id
        or not adapter_execution_dry_run_id
        or not adapter_runtime_preflight_id
        or not adapter_wiring_id
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if adapter_execution_gate_id and getattr(record, "resource_id", None) != adapter_execution_gate_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        if adapter_execution_dry_run_id and details.get("adapter_execution_dry_run_id") != adapter_execution_dry_run_id:
            continue
        if adapter_runtime_preflight_id and details.get("adapter_runtime_preflight_id") != adapter_runtime_preflight_id:
            continue
        if adapter_wiring_id and details.get("adapter_wiring_id") != adapter_wiring_id:
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        execution_gate = details.get("adapter_execution_gate")
        if not isinstance(execution_gate, dict):
            continue
        if runtime_flag_name and execution_gate.get("runtime_flag_name") != runtime_flag_name:
            continue
        execution_gate_payload = _jsonable(execution_gate)
        return {
            **execution_gate_payload,
            "execution_gate_opened": execution_gate_payload.get("execution_gate_opened", False),
            "record_outcome": getattr(record, "outcome", None),
            "audit_id": getattr(record, "id", audit_id),
            "audit_created_at": _jsonable(getattr(record, "created_at", None)),
            "audit_hash": getattr(record, "hash", None),
...
def _sdk_live_write_runner_execution_acceptance_record_from_audit(
    audit_store: AuditStore | None,
    *,
    execution_acceptance_id: str | None,
    approval_id: str | None,
    adapter_execution_gate_id: str | None,
    adapter_execution_gate_audit_id: str | None,
    adapter_execution_dry_run_id: str | None,
    adapter_runtime_preflight_id: str | None,
    adapter_wiring_id: str | None,
    adapter_code_change_id: str | None,
    ...
    if (
        audit_store is None
        or not execution_acceptance_id
        or not approval_id
        or not adapter_execution_gate_id
        or not adapter_execution_gate_audit_id
        or not adapter_execution_dry_run_id
        or not adapter_runtime_preflight_id
        or not adapter_wiring_id
        or not adapter_code_change_id
    ...
    for record in records:
        if audit_id and getattr(record, "id", None) != audit_id:
            continue
        if execution_acceptance_id and getattr(record, "resource_id", None) != execution_acceptance_id:
            continue
        details = getattr(record, "details", {}) or {}
        if approval_id and details.get("approval_id") != approval_id:
            continue
        if adapter_execution_gate_id and details.get("adapter_execution_gate_id") != adapter_execution_gate_id:
            continue
        if (
            adapter_execution_gate_audit_id
            and details.get("adapter_execution_gate_audit_id") != adapter_execution_gate_audit_id
        ):
            continue
        if adapter_execution_dry_run_id and details.get("adapter_execution_dry_run_id") != adapter_execution_dry_run_id:
            continue
        ...
        if final_decision_id and details.get("final_decision_id") != final_decision_id:
            continue
        execution_acceptance = details.get("live_write_runner_execution_acceptance")
        if not isinstance(execution_acceptance, dict):
            continue
        if runtime_flag_name and execution_acceptance.get("runtime_flag_name") != runtime_flag_name:
            continue
        execution_acceptance_payload = _jsonable(execution_acceptance)
        return {
            **execution_acceptance_payload,
            "execution_gate_opened": execution_acceptance_payload.get("execution_gate_opened", False),
            "write_runner_invoked": execution_acceptance_payload.get("write_runner_invoked", False),
            "live_execution_started": execution_acceptance_payload.get("live_execution_started", False),
            "record_outcome": getattr(record, "outcome", None),
            "audit_id": getattr(record, "id", audit_id),
            "audit_created_at": _jsonable(getattr(record, "created_at", None)),
            "audit_hash": getattr(record, "hash", None),
