...
def _register_all_routers() -> None:
    ...
    # Track C (2026-08): explicit keep-list registration. Only coding-agent
    # core domains are mounted; template domains (smart_*/mesh*/data_*/
    # distributed_*/billing/marketplace/ops/...) were archived to
    # archive/api_templates_2026-08/. See KEPT_ROUTERS.md there.
    import importlib
